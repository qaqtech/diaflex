...
<table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0" >
  ...
  <%
   ...
   ArrayList params = new ArrayList();
    ...
    String mprp = (String)request.getAttribute("mprp");
    String pgTtl = uiForms.getFORM_TTL();
   
    int addRec = Integer.parseInt(util.nvl(uiForms.getREC(),"10"));
   String formAction = "/contact/propertieMap.do?method=save" ;
 %>
 ...
 <html:hidden property="value(nmeIdn)" />
   <div class="memo">
    ...
    for(int dsp=0; dsp < dspOrder.size(); dsp++) {
      ...
      <%
        for(int j=0; j < daos.size(); j++) {
            ...
            String defineID = lFld+"_" +fldId+"_DF";
