...
<title>Rough Griding Packet Details Report</title>
...
<tr><td class="hedPg">Create Excel <img src="../images/ico_file_excel.png" border="0" onclick="goTo('<%=info.getReqUrl()%>/report/genericReport.do?method=createXL','','')"/>
 <%
  ArrayList rolenmLst=(ArrayList)info.getRoleLst();
  String usrFlg=util.nvl((String)info.getUsrFlg());
  if(usrFlg.equals("SYS") || rolenmLst.contains("ADMIN")){
  %>
 <img src="../images/edit.jpg" title="Edit Properties Module" onclick="newWindow('<%=info.getReqUrl()%>/dynamicProperty.do?method=load&mdl=RGHMKT_VW&sname=RGHMKT_REPORT&par=A')" border="0" width="15px" height="15px"/> 
  <%}%></td>
</tr>
<tr><td class="hedPg"><table class="dataTable" >
<%
HashMap mprp = info.getMprp();
ArrayList vwPrpList=(ArrayList)session.getAttribute("RGHMKT_VW");
