...
<html>
  <head>
    ...
    <title>Report Module Master</title>
...
<table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0" class="mainbg">
  ...
  <%
   ArrayList params = new ArrayList();
    ...
    String formName = "reportmoduleform";
...
<%}%>
 ...
 <html:form action="masters/reportmodule.do?method=save" method="post">
    <table class="grid1" >
    ...
    for(int dsp=0; dsp < dspOrder.size(); dsp++) {
      ...
      <%
       ...
       <% if(msg.equalsIgnoreCase("NEW")) {%>
        <td>&nbsp;</td>
        <%} else {
            String link1="/masters/moduleproperty.do?method=load&mdl="+ fldId ;
        %>
