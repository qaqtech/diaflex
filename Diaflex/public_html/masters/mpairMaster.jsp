...
<html>
  <head>
    ...
    <title>Matching Pair Master</title>
...
<%}%>
 ...
 <html:form action="masters/mpair.do?method=save" method="post">
    <table class="grid1" >
    ...
    for(int dsp=0; dsp < dspOrder.size(); dsp++) {
      ...
      <%
       ...
       <% if(msg.equalsIgnoreCase("NEW")) {%>
        <td>&nbsp;</td>
        <%} else {
            String link1="/masters/mpairproperty.do?method=load&rule_idn="+ fldId ;
        %>
