...
<html>
  <head>
    ...
    <title>Stock Status Definition</title>
...
<table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0" class="mainbg">
  ...
  <%
   ...
   ArrayList params = new ArrayList();
    ...
    String formAction = "/masters/stockstt.do?method=save";
 %>
 <tr>
    ...
    for(int dsp=0; dsp < dspOrder.size(); dsp++) {
      ...
      <%
        ...
        <%}else {
            ...
            String link= url+"/masters/stockstt.do?method=delete&id="+ fldId ;
