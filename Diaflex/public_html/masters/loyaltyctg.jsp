...
<table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0" class="mainbg">
  ...
  <%
   ArrayList params = new ArrayList();
    ...
    String formName = "loyaltyctgform";
    ...
    String formAction = "/masters/loyaltyctg.do?method=save";
 %>
 <tr>
...
<%
    ...
    for(int dsp=0; dsp < dspOrder.size(); dsp++) {
      ...
      <%
        ...
        <td>&nbsp;</td>
        <%} else {
            String link1="/masters/loyaltySlabs.do?method=load&ctgIdn="+fldId ;
        %>
        <td nowrap="nowrap"><html:link page="<%=link1%>">Add Loyalty Slabs </html:link></td>
        <%}%>
        </tr>  
    <%}
%>    
