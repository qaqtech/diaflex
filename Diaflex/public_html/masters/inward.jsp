...
<html>
  <head>
    ...
    <title>Ifrs Inward Details</title>
...
<table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0" class="mainbg">
  ...
  <%
   ArrayList params = new ArrayList();
    ...
    int addRec = Integer.parseInt(util.nvl("1","1"));
    String formAction = "/masters/aginward.do?method=save";
 %>
 <tr>
    ...
    for(int dsp=0; dsp < dspOrder.size(); dsp++) {
      ...
      <%
        ...
        <%}else {
            ...
            String link = info.getReqUrl() + "/masters/aginward.do?method=delete&idn="+ fldId ;
