...
<table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0" class="mainbg">
  ...
  <%
   ArrayList params = new ArrayList();
    ...
    ArrayList processList = (ArrayList)request.getAttribute("processList");
    ...
    String formAction = "/masters/processMstAction.do?method=save";
 %>
 <tr>
...
<%
    ...
    for(int dsp=0; dsp < dspOrder.size(); dsp++) {
        ...
        for(int i=0; i < lmt; i++) {
            ...
            String cbox = "";
            if(!(msg.equalsIgnoreCase("NEW"))) {
                fldId = Integer.parseInt((String)processList.get(i));
            }
      ...
      <%
        ...
        <td>&nbsp;</td>
        <%} else {
            String link1=info.getReqUrl()+"/masters/prcToPrcAction.do?method=load&pIdn="+ fldId ;
             String link2=info.getReqUrl()+"/masters/processPrpAction.do?method=load&pIdn="+ fldId ;
        %>
        <td nowrap="nowrap"><a href="<%=link1%>">Process To Process  </a>|<a href="<%=link2%>">Process To ALW  </a> </td>
        <%}%>
        </tr>  
    <%}
%>    
