...
<table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0" class="mainbg">
 ...
 <tr>
  ...
  <%}%>
    <tr><td class="tdLayout" valign="top">
 <html:form action="masters/mruleMst.do?method=save" method="post">
    <table class="grid1" >
       ...
       <% if(msg.equalsIgnoreCase("NEW")) {%>
        ...
        <%} else {
           if (fldId.indexOf("&") > -1) {
            ...
            String link1="/masters/ruleDtle.do?method=load&mruleIdn="+ fldId ;
        %>
        <td><html:link page="<%=link1%>">Add Rule </html:link></td>
        <%}%>
