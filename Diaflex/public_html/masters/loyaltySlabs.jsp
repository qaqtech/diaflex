...
<table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0" class="mainbg">
  ...
  <%
   ArrayList params = new ArrayList();
    ...
    String formName = "loyaltyslabsform";
 ...
 <tr>
  ...
  <html:hidden property="value(ctgIdn)" />
    <table class="grid1">
    ...
    for(int dsp=0; dsp < dspOrder.size(); dsp++) {
      ...
      <%
        ...
        <%
            ...
            <%}
              ...
              String dspFldPopV = "value("+ dspFldPop + ")";
               session.setAttribute(dspFld, ovQ);
       ...
       <%  if(msg.equalsIgnoreCase("NEW")) {%>
        <td>&nbsp;</td>
        <%} else {
           String link1 = info.getReqUrl() + "/masters/loyaltySlabs.do?method=delete&ctgIdn="+fldId ;
            String onclick = "return setDeleteConfirm('"+link1+"')";

        %>
        <td><html:link page="<%=link1%>" onclick="<%=onclick%>">Delete </html:link></td>
        <%}%>
...
<% } else { if(reqList.size() > 0) {%>
    <html:submit property="modify" value="Save Changes" styleClass="submit"/>
