...
<table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0" >
  ...
  <%
   ArrayList params = new ArrayList();
    ...
    String keyNme = (String)info.getValue("dept");
    if(pgTtl.indexOf("~") > -1)
    ...
    String formAction = "/masters/deptToEmpAction.do?method=save";
 %>
 ...
 <b> <%=pgTtl%></b>
  ...
  <html:hidden property="value(deptIdn)" />
    <table class="grid1">
