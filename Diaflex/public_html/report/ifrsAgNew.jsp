...
<html:form action="/report/ifrsactionagNew.do?method=fetch"  method="POST">
   <table>
   <tr>
...
<tr>
  ...
  if(!sttName.equalsIgnoreCase("Opening")){
      ...
      if(sttName.equals("Mfg New")){
       ...
       status = "CLOSE";
     } else if(sttName.equals("Transfer Out")){
       status = "TRF";
     } else if(sttName.equals("Transfer In")){
       status = "TRF_IN";
     } else{
         status = "DLV";
      }
      ...
      String serPathPktDtl = "ifrsactionagNew.do?method=getPktDtl&asondate="+asondate+"&bkt="+ifrsData+"&sttName="+status+"&asontodate="+asontodate;
  ...
  if(!sttName.equalsIgnoreCase("Opening") ){
      ...
      String serPathPktDtl = "ifrsactionagNew.do?method=getPktDtl&asondate="+asondate+"&bkt="+bkt+"&sttName="+status+"&asontodate="+asontodate;
      if(!cts.equals("0.00")  &&  !cts.equals("0")){ 
           ctsLink = "<a href=\""+serPathPktDtl+"\"  target=\"PKTDTL\">"+cts+"</a>";
      }
  }
