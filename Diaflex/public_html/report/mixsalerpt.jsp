...
<html:form action="/report/orclRptAction.do?method=mixsalerpt"  method="POST">
  <table>
<tr>
<td>Buyer</td>
<td nowrap="nowrap">
...
<td>Date From : </td><td>
  ...
  <%String view= util.nvl((String)request.getAttribute("View"));
    ...
    ArrayList repMemoLst =(ArrayList)session.getAttribute("mixsaleprpLst");
    int repMemoLstsz=repMemoLst.size()-1;
    if(!view.equals("")){
    %>
    <%
  ...
  <display:table name="sessionScope.orclReportForm.pktList" class="displayTable" requestURI="" export="true"  sort="list" >
   <display:column property="Sr" title="Sr" />
    ...
    <display:column property="emp"  title="Emp"/>
    ...
    <% for (int j = 0; j < repMemoLstsz; j++) {
     String lprp = (String)repMemoLst.get(j);
     String titleprp=lprp;
     if(titleprp.equals("MIX_SIZE"))
     titleprp="SIZE";
     if(titleprp.equals("MIX_CLARITY"))
     titleprp="Quality";
     if(titleprp.equals("CRTWT"))
     titleprp="Carat";
    if(prpDspBlocked.contains(lprp)){
    }else{%>
  <display:column property="<%=lprp%>" title="<%=titleprp%>"  /> 
  <%}}%>
    ...
    <display:column property="srtavg"  title="Rem. SRTAvg"  />
    <display:column property="ExpThrough"  title="Exp Through"  />
    <display:column property="Exp Per"  title="Exp Per"  />
    <display:column property="Handle"  title="Handle"  />
    <display:column property="Blind"  title="Blind"  />
    <display:column property="Net"  title="Net"  />
    <display:column property="Show Sale"  title="Rem. SRTAvg"  />
    <display:column property="Big Deal"  title="Big Deal"  /> 
    <display:column property="New Customer"  title="New Customer"  />
    <display:column property="Refered to Other Department"  title="Refered to Other Department"  />
    <display:column property="Data Search"  title="Data Search"  />
    <display:column property="Co-Ordinator"  title="Co-Ordinator"  />
    <display:column property="Propose for other dept"  title="Propose for other dept"  />
    <display:column property="Reference"  title="Reference"  />
    <display:column property="Rapnet/Direct"  title="Rapnet/Direct"  />
    <display:column property="Follow Up"  title="Follow Up"  />
    <display:column property="Exibition"  title="Exibition"  />
    <display:column property="Exibition name"  title="Exibition name"  />
    <display:column property="Trip"  title="Trip"  />
    <display:column property="Show SalesKit"  title="Show SalesKit"  />
