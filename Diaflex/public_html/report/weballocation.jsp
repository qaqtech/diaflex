...
<html>
 ...
 <meta http-equiv="Content-Type" content="text/html; charset=windows-1252"/>
  ...
  <title>Web Allocation Report</title>
 ...
 Web Allocation Report</span> </td>
  ...
  <%
   ...
   <tr><td valign="top" class="hedPg"  >
    <html:form action="/report/orclRptAction?method=webAlcReport" method="post"  >
    <table>
    <tr><td>Date : </td>  
   ...
   %>
  <tr>
  <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Create Excel <img src="../images/ico_file_excel.png" onclick="goTo('orclRptAction.do?method=createWlcXL','','')" border="0"/> 
  </td>
  </tr>
   <tr>
