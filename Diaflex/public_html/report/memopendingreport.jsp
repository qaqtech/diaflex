...
<html>
 ...
 <meta http-equiv="Content-Type" content="text/html; charset=windows-1252"/>
  ...
  <title>Memo Pending  Reports</title>
...
<table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0" class="mainbg">
  ...
  <tr>
  <td valign="top" class="hedPg">
  <html:form action="report/orclReportAction.do?method=fetchmemoPnd" method="post">
...
<%if(cnt.equals("hk")){%>
   ...
   <%}%>
<%}if(flg1.equals("IDATE")){%>
  <tr><td><%=fld_nme%></td>
  <td>
    <table><tr>
      <td>From</td><td>
        <div class="float"> <html:text property="value(ifrmDte)"  styleId="appfrmDte" /></div>
      ...
      <td>To</td><td>
        <div class="float"> <html:text property="value(itoDte)"  styleId="apptoDte" /></div>
