...
<bean:write property="reportNme" name="groupWiseForm" />
  ...
  <tr><td valign="top" class="hedPg">Create Excel <img src="../images/ico_file_excel.png" title="Click here to Generate Excel" onclick="goToCreateXl('group.do?method=createGridXL&excelNm=Color/Purity&Report=CO')" border="0"/>&nbsp; 
  ...
  <td align="right" style="padding:0px"><span id="CTS_<%=j%>_<%=k%>" style="display:none;"><a title="Packet Details" target="_blank"  href="group.do?method=pktDtl&group=<%=group%>&lab=<%=lab%>&stt=<%=stt%>&sh=<%=sh%>&sz=<%=sz%>&col=<%=col%>&clr=<%=clr%>&loc=<%=locS%>&mlot=<%=mlot%>" ><%=Cts%></a></span></td>
  ...
  %>
  <td align="right" style="padding:0px"><%=Qty%></td>
   <td align="right" style="padding:0px"><span id="TOTALCTS_<%=j%>" style="display:none;"><a title="Packet Details" target="_blank"  href="group.do?method=pktDtl&group=<%=group%>&lab=<%=lab%>&stt=<%=stt%>&sh=<%=sh%>&sz=<%=sz%>&col=<%=col%>&clr=ALL&loc=<%=locS%>&mlot=<%=mlot%>" ><%=Cts%></a></span></td>
  ...
  %>
  <td align="right" style="padding:0px"><%=Qty%></td>
  <td align="right" style="padding:0px"><span id="TTLCTS_<%=i%>" style="display:none;"><a title="Packet Details" target="_blank"  href="group.do?method=pktDtl&group=<%=group%>&lab=<%=lab%>&stt=<%=stt%>&sh=<%=sh%>&sz=<%=sz%>&col=ALL&clr=<%=clr%>&loc=<%=locS%>&mlot=<%=mlot%>" ><%=Cts%></a></span></td>
  ...
  %>
  <td align="right" style="padding:0px"><%=Qty%></td>
   <td align="right" style="padding:0px"><span id="GTTLCTS" style="display:none;"><a title="Packet Details" target="_blank"  href="group.do?method=pktDtl&group=<%=group%>&lab=<%=lab%>&stt=<%=stt%>&sh=<%=sh%>&sz=<%=sz%>&col=ALL&clr=ALL&loc=<%=locS%>&mlot=<%=mlot%>" ><%=Cts%></a></span></td>
