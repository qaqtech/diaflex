...
<table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0">
 ...
 Stock Report Opening/Closing</span> </td>
  ...
  <b>Criteria :</b><%=perioddtlmsg%><bean:write property="value(criteria)" name="genericReportFormMG" /></td></tr>
  <tr>
<td valign="top" class="hedPg">
<html:hidden property="value(filterlprp)" styleId="filterlprp" value="<%=filterlprp%>" />
  Next Grid By : <html:select property="value(gridbylprp)" name="genericReportFormMG"  style="width:100px" styleId="gridbylprp" onchange=""  >
