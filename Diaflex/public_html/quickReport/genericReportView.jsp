...
<div id="fixedheader">
  ...
  <td valign="top" class="hedPg"><span class="txtLink">
  <%if(!processtm.equals("")){%>
  <b><%=processtm%></b>
  <%}
  ...
  <%}}}else{%>
  Search Description <%=mongosrchDsc%>
  <%}%>
  </span></td>
  </tr></table>
  </td></tr>
 ...
 <table class="genericTB" id="ADVFEAR" style="display:none; width:50%;color:black;">
  <%        pageList=(ArrayList)pageDtl.get("GRIDFMT");
    ...
    <tr><td style="<%=dflt_val%>">Grid Format:
    <html:select  property="value(gridfmt)" name="genericReportFormMG" styleId="gridfmt" onchange="redirectAnalysissave();" > 
...
if(fld_ttl.equals("Color Pie Graph") || fld_ttl.equals("Clarity Pie Graph")){
%>
...
<span class="txtLink" id="chart">Pie Chart</span></a>-->
 ...
 <A href="<%=info.getReqUrl()%>/quickReport/barGraph.jsp?key=<%=replaceplus%>&row=&col=<%=colV%>" target="SC"  onclick="loadASSFNLPop('chart')" title="Click Here To See Bar Graph">
<img src="../images/barchart.png" id="chart" border="0" />
</a>
<A href="<%=info.getReqUrl()%>/quickReport/commonpieChart.jsp?key=<%=replaceplus%>&row=&col=<%=colV%>" target="SC"  onclick="loadASSFNLPop('chart')" title="Click Here To See Pie Chart">
<img src="../images/piechart.png" id="chart" border="0" />
  ...
  <th  colspan="<%=sttLstSize*genericcolspan%>">Total
   <%if(isShowgraph.equals("Y")){%>
  <A href="<%=info.getReqUrl()%>/quickReport/barGraph.jsp?key=<%=replaceplus%>&row=&col=ALL" target="SC"  onclick="loadASSFNLPop('chart')" title="Click Here To See Bar Graph">
<img src="../images/barchart.png" id="chart" border="0" /></a>
<A href="<%=info.getReqUrl()%>/quickReport/commonpieChart.jsp?key=<%=replaceplus%>&row=&col=ALL" target="SC"  onclick="loadASSFNLPop('chart')" title="Click Here To See Pie Chart">
...
<%}}}}%> 
 ...
 <%}%>
  ...
  <tr> <td nowrap="nowrap"><%=rowV%><input type="checkbox" name="checkCol" id="<%=checkCol%>" value="<%=rowV%>"/>
   <%if(isShowgraph.equals("Y")){%>
  <A href="<%=info.getReqUrl()%>/quickReport/barGraph.jsp?key=<%=replaceplus%>&row=<%=rowV%>&col=" target="SC"  onclick="loadASSFNLPop('chart')" title="Click Here To See Bar Graph">
<img src="../images/barchart.png" border="0" id="chart"/></a>
<A href="<%=info.getReqUrl()%>/quickReport/commonpieChart.jsp?key=<%=replaceplus%>&row=<%=rowV%>&col=" target="SC"  onclick="loadASSFNLPop('chart')" title="Click Here To See Pie Chart">
...
String bocolor=util.nvl((String)sttColorCodeMap.get(stt),"black");
    ...
    <td align="center" style="cursor: pointer;" onclick="genericDtlQuick('genericReport.do?method=loadDtl&key=<%=keyQty%>')" title="Click To See Details">
    <span id="<%=qtyId%>" style="">
    <%=valQty%>
...
<%}}}}%> 
  ...
  String stt=(String)statusLst.get(sti);
    String getcolttlqty=util.nvl((String)dataDtl.get(key+"@"+rowV+"@"+stt+"@QTY"));
    String getcolttlcts=util.nvl((String)dataDtl.get(key+"@"+rowV+"@"+stt+"@CTS"));
    String getcolttlavg=util.nvl((String)dataDtl.get(key+"@"+rowV+"@"+stt+"@AVG"));
    String getcolttlrap=util.nvl((String)dataDtl.get(key+"@"+rowV+"@"+stt+"@RAP"));
    String getcolttlage=util.nvl((String)dataDtl.get(key+"@"+rowV+"@"+stt+"@AGE"));
    String getcolttlhit=util.nvl((String)dataDtl.get(key+"@"+rowV+"@"+stt+"@HIT"));
    String getcolttlvlu=util.nvl((String)dataDtl.get(key+"@"+rowV+"@"+stt+"@VLU"));
    String svpd="";
    String msd="";
...
//     piePrpDtl.put(key+"_"+stt+"_"+rowV+"_"+"COL",getcolttlqty);
     ...
     if(statusLst.contains("MKT") && statusLst.contains("SOLD") && (stt.equals("SOLD") || stt.equals("MKT")) && inventoryDis.equals("Y")) {
     String mktKeyVlu = key+"@"+rowV+"@MKT@VLU";
     String mktVlu = util.nvl2((String)dataDtl.get(mktKeyVlu),"0");
     String soldKeyVlu = key+"@"+rowV+"@SOLD@VLU";
     String soldVlu = util.nvl2((String)dataDtl.get(soldKeyVlu),"0");
     if(!soldVlu.equals("") && !soldVlu.equals("0")){
     svpd=util.nvl(String.valueOf(Math.round(Double.parseDouble(soldVlu)/days)),"0");
     if(!mktVlu.equals("") && !mktVlu.equals("0") && !svpd.equals("0"))
    ...
    %>
  <td style="<%=style%>"><table class="wdth" cellpadding="0" cellspacing="4"><tr>	
  <td align="center" style="cursor: pointer;" onclick="genericDtlQuick('genericReport.do?method=loadDtl&key=<%=key%>@<%=rowV%>@ALL@<%=stt%>')" title="Click To See Details">
...
if(!fld_ttl.equals("QTY") && !fld_ttl.equals("CTS") && !fld_ttl.equals("AVG") && !fld_ttl.equals("RAP")){
 ...
 getcolttlshowprp=util.nvl((String)dataDtl.get(key+"@"+rowV+"@"+stt+"@"+fld_ttl));
  String blue="";
 if(j%2!=0)
 blue=" class=\"BlueTxt\"";
%>
...
<%}}}}%> 
  ...
  <tr><td nowrap="nowrap">Total
   <%if(isShowgraph.equals("Y")){%>
  <A href="<%=info.getReqUrl()%>/quickReport/barGraph.jsp?key=<%=replaceplus%>&row=ALL&col=" target="SC"  onclick="loadASSFNLPop('chart')" title="Click Here To See Bar Graph">
<img src="../images/barchart.png" border="0" id="chart"/></a>
<A href="<%=info.getReqUrl()%>/quickReport/commonpieChart.jsp?key=<%=replaceplus%>&row=ALL&col=" target="SC"  onclick="loadASSFNLPop('chart')" title="Click Here To See Pie Chart">
<img src="../images/piechart.png" border="0" id="chart"/></a><%}%>
  </td>
  <%  
  colnum=0;
  for(int j=0;j< colList.size();j++){
    ...
    colnum++;
    String stt=(String)statusLst.get(st);
    String getclrttlqty=util.nvl((String)dataDtl.get(key+"@"+colV+"@"+stt+"@QTY"));
    String getclrttlcts=util.nvl((String)dataDtl.get(key+"@"+colV+"@"+stt+"@CTS"));
    String getclrttlavg=util.nvl((String)dataDtl.get(key+"@"+colV+"@"+stt+"@AVG"));
    String getclrttlrap=util.nvl((String)dataDtl.get(key+"@"+colV+"@"+stt+"@RAP"));
    String getclrttlage=util.nvl((String)dataDtl.get(key+"@"+colV+"@"+stt+"@AGE"));
    String getclrttlhit=util.nvl((String)dataDtl.get(key+"@"+colV+"@"+stt+"@HIT"));
    String getclrttlvlu=util.nvl((String)dataDtl.get(key+"@"+colV+"@"+stt+"@VLU"));
...
String bocolor=util.nvl((String)sttColorCodeMap.get(stt),"black");
     ...
     if(statusLst.contains("MKT") && statusLst.contains("SOLD") && (stt.equals("SOLD") || stt.equals("MKT")) && inventoryDis.equals("Y")) {
     String mktKeyVlu = key+"@"+colV+"@MKT@VLU";
     String mktVlu = util.nvl2((String)dataDtl.get(mktKeyVlu),"0");
     String soldKeyVlu = key+"@"+colV+"@SOLD@VLU";
     String soldVlu = util.nvl2((String)dataDtl.get(soldKeyVlu),"0");
     if(!soldVlu.equals("") && !soldVlu.equals("0")){
     svpd=util.nvl(String.valueOf(Math.round(Double.parseDouble(soldVlu)/days)),"0");
     if(!mktVlu.equals("") && !mktVlu.equals("0") && !svpd.equals("0"))
    ...
    %>
  <td style="<%=style%>"><table class="wdth" cellpadding="0" cellspacing="4"><tr>	
 <td align="center"  style="cursor: pointer;" onclick="genericDtlQuick('genericReport.do?method=loadDtl&key=<%=key%>@ALL@<%=colV%>@<%=stt%>')" title="Click To See Details">
...
if(!fld_ttl.equals("QTY") && !fld_ttl.equals("CTS") && !fld_ttl.equals("AVG") && !fld_ttl.equals("RAP")){
 ...
 getclrttlshowprp=util.nvl((String)dataDtl.get(key+"@"+colV+"@"+stt+"@"+fld_ttl));
   String blue="";
 if(pp%2!=0)
 blue=" class=\"BlueTxt\"";
%>
...
style = "";
   ...
   %>
  <td style="<%=style%>"><table class="wdth" cellpadding="0" cellspacing="4"><tr>	
  <td align="center" style="cursor: pointer;" onclick="genericDtlQuick('genericReport.do?method=loadDtl&key=<%=key%>@ALL@ALL@<%=stt%>')" title="Click To See Details">
