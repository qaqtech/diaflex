...
<img src="../images/loadbig.gif" />
  ...
  <html:form action="assort/assortFinalRtn.do?method=bulkUpdate" method="post">
  <%
  //util.updAccessLog(request,response,"AssortMutiUpd", "AssortMutiUpd");
 ...
 <label id="msg" class="redLabel"></label></td></tr>
...
<tr><td valign="top" height="95%">
  ...
  <html:select property="<%=fldName%>" styleId="<%=lprp%>" onchange="<%=bulkUpdate%>"  name="assortFinalRtnForm" >
  ...
  <%}else{%>
  <html:text property="<%=fldName%>" size="5"  styleId="<%=lprp%>" onchange="<%=bulkUpdate%>"  name="assortFinalRtnForm"/>
  <%}%>
  </td> </tr>
  <%}%>
