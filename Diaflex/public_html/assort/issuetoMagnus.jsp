...
<%
   //util.updAccessLog(request,response,"Magnus Issue", "Magnus Issue");
...
<table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0" class="mainbg">
  ...
  <tr>
    <td valign="top" class="hedPg">
      ...
      <img src="../images/line.jpg" border="0" /></td><td valign="middle"> <span class="pgHed">Magnus Check Issue</span> </td>
      </tr></table>
    </td>
  </tr>
  <%
   ...
   <table><tr><td>
   <html:form action="assort/issuetoMagnus.do?method=fetch" method="post" onsubmit="return validate_assort()">
    <table  class="grid1">
      ...
      <tr>
        <td valign="top">
         ...
         <tr><td>Process </td>
         <td>
         <html:select property="value(mprcIdn)"  styleId="mprcIdn" name="issuetoMagnusForm" disabled="<%=disabled%>"   >
                 <html:option value="0" >--select--</html:option>
                  <html:optionsCollection property="mprcList" name="issuetoMagnusForm" 
         ...
         <tr>
           <td>  Employee : </td>
           <td>
           <html:select property="value(empIdn)"  styleId="empIdn" name="issuetoMagnusForm" disabled="<%=disabled%>"  >
                   <html:option value="0" >--select--</html:option>
                    <html:optionsCollection property="empList" name="issuetoMagnusForm" 
                    label="emp_nme" value="emp_idn" />
                    </html:select>
           </td>
         </tr>
         <tr>
            <td>Barcode:</td><td> <html:textarea property="value(vnmLst)" rows="7"  cols="30" name="issuetoMagnusForm"  /></td>
         </tr>
        </table>
        </td>
   ...
   if(view!=null)
   {
      ...
      if(stockList!=null && stockList.size()>0)
      {
        ...
        <html:form action="assort/issuetoMagnus.do?method=Issue" method="post" onsubmit="return validate_issue('CHK_' , 'count')">
         <html:hidden property="value(prcId)" name="issuetoMagnusForm" />
         <html:hidden property="value(empId)" name="issuetoMagnusForm" />
           ...
           <td>
            <table class="grid1">
              ...
              for(int i=0; i < stockList.size(); i++ )
              {
                 ...
                 %>
                  <tr>
                  <td><html:checkbox property="<%=checkFldVal%>" styleId="<%=checkFldId%>" name="issuetoMagnusForm" onclick="<%=onclick%>" value="yes" /> </td>
                  <td><%=sr%></td>
