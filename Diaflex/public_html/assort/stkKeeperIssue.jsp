...
//util.updAccessLog(request,response,"Stk Keeper Issue", "Stk Keeper Issue");
...
<table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0" class="mainbg">
  ...
  <%
   ...
   <table><tr><td>
   <html:form action="assort/stkKeeperIssue.do?method=fetch" method="post" onsubmit="return validate_assort()">
    <table  class="grid1">
      ...
      <tr>
        <td valign="top">
         ...
         <!---<tr><td>Process </td>
         <td>
         <html:select property="value(mprcIdn)"  styleId="mprcIdn" name="stkKprIssueForm" disabled="<%=disabled%>"   >
                 <html:option value="0" >--select--</html:option>
                  <html:optionsCollection property="mprcList" name="stkKprIssueForm" 
                  label="prc" value="mprcId" />
          </html:select>
         </td></tr>--->
         <html:hidden property="value(mprcIdn)" styleId="mprcIdn"  name="stkKprIssueForm" value="<%=prcid%>" />
         
         <tr>
           <td>  Employee : </td>
           <td>
           <html:select property="value(empIdn)"  styleId="empIdn" name="stkKprIssueForm" disabled="<%=disabled%>"  >
                   <html:option value="0" >--select--</html:option>
                    <html:optionsCollection property="empList" name="stkKprIssueForm" 
                    label="emp_nme" value="emp_idn" />
                    </html:select>
           </td>
         </tr>
         <tr>
            <td>Barcode:</td><td> <html:textarea property="value(vnmLst)" rows="7"  cols="30" name="stkKprIssueForm"  /></td>
         </tr>
        </table>
        </td>
   ...
   if(view!=null)
   {
      ...
      if(stockList!=null && stockList.size()>0)
      {
        ...
        <html:form action="assort/stkKeeperIssue.do?method=Issue" method="post" onsubmit="return validate_issue('CHK_' , 'count')">
         <html:hidden property="value(prcId)" name="stkKprIssueForm" value="<%=prcid%>" />
         <html:hidden property="value(empId)" name="stkKprIssueForm" />
           ...
           <td>
            <table class="grid1">
              ...
              for(int i=0; i < stockList.size(); i++ )
              {
                 ...
                 %>
                  <tr>
                  <td><html:checkbox property="<%=checkFldVal%>" styleId="<%=checkFldId%>" name="stkKprIssueForm" onclick="<%=onclick%>" value="yes" /> </td>
                  <td><%=sr%></td>
