...
<html>
  <head>
       <%
  ArrayList itemHdr = (ArrayList)request.getAttribute("itemHdr_E");
  ArrayList dtlsList = (ArrayList)request.getAttribute("dtlList_E");
  String hdrnme = (String)request.getAttribute("hdrnme_E");
   String  externalrfsh = (String)request.getAttribute("externalrfsh");
...
<tr><td valign="top"><b style="font-size:10px;"><%=hdrnme%>  </b></td></tr>
      ...
      <div id="main">
    <display:table name="sessionScope.userrightsform.pktEList" requestURI=""   sort="list" class="boardgrid"  style="width:100%;" >
