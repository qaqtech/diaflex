...
<html>
  <head>
       <%
  ArrayList itemHdr = (ArrayList)request.getAttribute("itemHdr_EAP");
  ArrayList dtlsList = (ArrayList)request.getAttribute("dtlList_EAP");
  String hdrnme = (String)request.getAttribute("hdrnme_EAP");
   String  extapprfsh = (String)request.getAttribute("extapprfsh");
...
<tr><td valign="top"><b style="font-size:10px;"><%=hdrnme%>  </b></td></tr>
     ...
     <div id="main">
    <display:table name="sessionScope.userrightsform.pktEAPList" requestURI=""   sort="list" class="boardgrid"  style="width:100%;" >
