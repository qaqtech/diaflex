...
<html>
  <head>
       <%
  ArrayList itemHdr = (ArrayList)request.getAttribute("itemHdr_WH");
  ArrayList dtlsList = (ArrayList)request.getAttribute("dtlList_WH");
  String hdrnme = (String)request.getAttribute("hdrnme_WH");
   String  holdrfsh = (String)request.getAttribute("holdrfsh");
...
<tr><td valign="top"><b style="font-size:10px;"><%=hdrnme%>  </b></td></tr>
      ...
      <div id="main">
    <display:table name="sessionScope.userrightsform.pktWHList" requestURI=""   sort="list" class="boardgrid"  style="width:100%;" >
