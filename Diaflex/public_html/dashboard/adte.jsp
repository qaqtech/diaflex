...
<html>
  <head>
  <%
  ArrayList itemHdr = (ArrayList)request.getAttribute("itemHdr_ADTE");
  ArrayList dtlsList = (ArrayList)request.getAttribute("dtlList_ADTE");
  String hdrnme = (String)request.getAttribute("hdrnme_ADTE");
   String  rfshadte = util.nvl((String)request.getAttribute("rfshadte"));
...
<tr><td valign="top"><b style="font-size:10px;"><%=hdrnme%>  </b></td></tr>
      ...
      <div id="main">
    <display:table name="sessionScope.userrightsform.pktADTEList" requestURI=""   sort="list" class="boardgrid"  style="width:100%;" >
    <%for(int i=0;i<itemHdr.size();i++){
    String hdr = util.nvl((String)itemHdr.get(i));
    if(hdr.equals("Person")||hdr.equals("Sale Person")){%>
