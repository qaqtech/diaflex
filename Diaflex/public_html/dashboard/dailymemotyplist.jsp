...
<html>
  <head>
     <%
ArrayList  dtlList = (ArrayList)request.getAttribute("dailyMemoR_Z");
  String hdrnme = (String)request.getAttribute("hdrnme_Z");
   String  memotypZrfsh = (String)request.getAttribute("memotypZrfsh");
