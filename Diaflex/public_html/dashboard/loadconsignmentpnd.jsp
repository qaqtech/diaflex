...
<html>
  <head>
       <%
  ArrayList itemHdr = (ArrayList)request.getAttribute("itemHdr_CSPND");
  ArrayList dtlsList = (ArrayList)request.getAttribute("dtlList_CSPND");
  String hdrnme = (String)request.getAttribute("hdrnme_CSPND");
   String  consignmentpndrfsh = (String)request.getAttribute("consignmentpndrfsh");
...
<tr><td valign="top"><b style="font-size:10px;"><%=hdrnme%>  </b></td></tr>
      ...
      <div id="main">
    <display:table name="sessionScope.userrightsform.pktCSList" requestURI=""   sort="list" class="boardgrid"  style="width:100%;" >
