...
<html>
  <head>
     <%
ArrayList  dtlList = (ArrayList)request.getAttribute("dtlList_B");
  String hdrnme = (String)request.getAttribute("hdrnme_B");
   String  purbuyrfsh = (String)request.getAttribute("purbuyrfsh");
...
<%if(view.equals("Y")){
  ...
  <tr>
   ...
   <td align="right"><%=util.nvl((String)byrdata.get("QTY"))%></td>
    <td align="right"><%=util.nvl((String)byrdata.get("AVG"))%></td>
