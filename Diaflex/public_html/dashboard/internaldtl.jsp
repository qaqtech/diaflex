...
<html>
  <head>
       <%
  ArrayList itemHdr = (ArrayList)request.getAttribute("itemHdr_I");
  ArrayList dtlsList = (ArrayList)request.getAttribute("dtlList_I");
  String hdrnme = (String)request.getAttribute("hdrnme_I");
   String  internalrfsh = (String)request.getAttribute("internalrfsh");
...
<tr><td valign="top"><b style="font-size:10px;"><%=hdrnme%>  </b></td></tr>
      ...
      <div id="main">
    <display:table name="sessionScope.userrightsform.pktIList" requestURI=""   sort="list" class="boardgrid"  style="width:100%;" >
