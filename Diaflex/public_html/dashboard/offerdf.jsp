...
<html>
  <head>
     <%
  ArrayList  byridnLst = (ArrayList)request.getAttribute("byridnLst_DF");
  HashMap  byrdtl = (HashMap)request.getAttribute("byrdtl_DF");
  HashMap  dataDtl = (HashMap)request.getAttribute("dataDtl_DF");
  String hdrnme = (String)request.getAttribute("hdrnme_DF");
   String  offerdfrfsh = (String)request.getAttribute("offerdfrfsh");
