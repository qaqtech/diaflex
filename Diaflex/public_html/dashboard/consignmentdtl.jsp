...
<html>
  <head>
     <%
  ArrayList  dtlList = (ArrayList)request.getAttribute("dtlList_CS");
  String hdrnme = (String)request.getAttribute("hdrnme_CS");
   String  consignmentrfsh = (String)request.getAttribute("consignmentrfsh");
  String  view = (String)request.getAttribute("view");
   String url="ajaxdashAction.do?method=dashbuyerwisePieChart&defaultdisplay=5";
   String style="width: 55%; height: 362px; "; 
   String styleId="CS_DIV";
   String title="Daily Consignment Report";
