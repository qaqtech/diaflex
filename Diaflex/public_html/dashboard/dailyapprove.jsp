...
<html>
  <head>
    <%
  ArrayList  dtlList = (ArrayList)request.getAttribute("dtlList_approve");
  String hdrnme = (String)request.getAttribute("hdrnme_approve");
   String  dapproverfsh = (String)request.getAttribute("dapproverfsh");
   String  view = (String)request.getAttribute("view");
   String url="ajaxdashAction.do?method=dashbuyerwisePieChart&defaultdisplay=5";
   String style="width: 55%; height: 362px; "; 
   String styleId="AP_DIV";
   String title="Daily Approve Report";
