...
<html>
  <head>
     <%
ArrayList  dtlList = (ArrayList)request.getAttribute("dtlList_R");
  String hdrnme = (String)request.getAttribute("hdrnme_R");
   String  purreviewrfsh = (String)request.getAttribute("purreviewrfsh");
...
<%if(view.equals("Y")){
  ...
  <tr>
  <th>Vender</th><th>Qty</th><th>Avg</th><th>Cts</th><th>Value</th>
  </tr>
