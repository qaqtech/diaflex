...
<html>
  <head>
       <%
  ArrayList itemHdr = (ArrayList)request.getAttribute("itemHdr_WAP");
  ArrayList dtlsList = (ArrayList)request.getAttribute("dtlList_WAP");
  String hdrnme = (String)request.getAttribute("hdrnme_WAP");
   String  webapprfsh = (String)request.getAttribute("webapprfsh");
...
<tr><td valign="top"><b style="font-size:10px;"><%=hdrnme%>  </b></td></tr>
      ...
      <div id="main">
    <display:table name="sessionScope.userrightsform.pktWAPList" requestURI=""   sort="list" class="boardgrid"  style="width:100%;" >
