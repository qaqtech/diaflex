...
<html>
  <head>
  <%
  ArrayList itemHdr = (ArrayList)request.getAttribute("itemHdr_IAP");
  ArrayList dtlsList = (ArrayList)request.getAttribute("dtlList_IAP");
  String hdrnme = (String)request.getAttribute("hdrnme_IAP");
   String  intapprfsh = (String)request.getAttribute("intapprfsh");
...
<tr><td valign="top"><b style="font-size:10px;"><%=hdrnme%>  </b></td></tr>
      ...
      <div id="main">
    <display:table name="sessionScope.userrightsform.pktIAPList" requestURI=""   sort="list" class="boardgrid"  style="width:100%;" >
