...
<html>
  <head>
     <%
ArrayList  dtlList = (ArrayList)request.getAttribute("dtlList_SLRTN");
HashMap  salExDtl = (HashMap)request.getAttribute("salExList_SLRTN");
  String hdrnme = util.nvl((String)request.getAttribute("hdrnme_SLRTN"));
   String  salertnrfsh = util.nvl((String)request.getAttribute("salertnrfsh"));
