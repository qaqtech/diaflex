...
<html>
  <head>
  <%
  ArrayList itemHdr = (ArrayList)request.getAttribute("itemHdr_DOB");
  ArrayList dtlsList = (ArrayList)request.getAttribute("dtlList_DOB");
  String hdrnme = (String)request.getAttribute("hdrnme_DOB");
   String  rfshdob = (String)request.getAttribute("rfshdob");
...
<tr><td valign="top"><b style="font-size:10px;"><%=hdrnme%>  </b></td></tr>
      ...
      <div id="main">
    <display:table name="sessionScope.userrightsform.pktDOBList" requestURI=""   sort="list" class="boardgrid"  style="width:100%;" >
