...
<script type="text/javascript" src="<%=info.getReqUrl()%>/scripts/bse.js?v=<%=info.getJsVersion()%> " > </script>
    ...
    ArrayList  vwPrpLst = (ArrayList)session.getAttribute("filterlprpLst_mix");
    ArrayList  grpList = (ArrayList)session.getAttribute("dashboardgrpList_mix");
    ArrayList orignalvWPrpList=(ArrayList)session.getAttribute("DASH_GRP_COMP_MIX");
    ArrayList vWPrpListAll = (ArrayList)session.getAttribute("DASH_GRP_COMP_MIX_ALL");
...
<html:form action="dashboard/screen.do?method=fetchgrpcompmix" method="post" onsubmit="" >
...
pageList= ((ArrayList)pageDtl.get("SUBMIT") == null)?new ArrayList():(ArrayList)pageDtl.get("SUBMIT");
            ...
            %>
            <span class="txtLinkdashboard" id="<%=dflt_val%>_TAB" style="<%=color%>"  onclick="showHideDivDashboardMix('boardgrid','<%=dflt_val%>',this,'_TAB')"> <%=fld_ttl%></span>
            <%}}%>
</td>
</tr>
</table>
...
<div>
<html:form action="dashboard/screen.do?method=filtergrpcompmix" method="post" onsubmit="" >
<table class="boardgridPrp" id="boardgridPrp">
<tr>
<td align="center" nowrap="nowrap">
<html:select property="value(filterlprp)" name="userrightsform"  style="width:100px" styleId="filterlprp" onchange="displayfilterQuickMix();"  >
...
<tr>
<td colspan="3">
<span class="txtLinkdashboard" id="CTS_CTSVLUTAB" style=""  onclick="refreshboardgridPrpCTSVLUMix('boardgridPrp','CTS',this,'_CTSVLUTAB')"> CTS</span>
<span class="txtLinkdashboard" id="VLU_CTSVLUTAB" style="color:#ffffff"  onclick="refreshboardgridPrpCTSVLUMix('boardgridPrp','VLU',this,'_CTSVLUTAB')"> VLU</span>
|
<span class="txtLinkdashboard" id="PRP_PRPGRPTAB" style="color:#ffffff"  onclick="refreshboardgridPrpPRPGRPMix('boardgridPrp','PRP',this,'_PRPGRPTAB')"> PRP Wise</span>
<span class="txtLinkdashboard" id="GRP_PRPGRPTAB" style=""  onclick="refreshboardgridPrpPRPGRPMix('boardgridPrp','GRP',this,'_PRPGRPTAB')"> GRP Wise</span>
</td>
</tr>
 <tr>
...
<%
    ...
    barGrp = barGrp.replaceAll(" ", "");
  url="screen.do?method=grpcomparasionBarChartPrpWiseMix&filterlprp="+vwPrpLst.get(0);
...
callcreateMultipleBarGraphmultionPgCtsVlu('<%=url%>','<%=filterDsc%> - <%=util.nvl((String)mprp.get(vwPrpLst.get(0)+"D"))%> Wise','50','362');
});
 -->
</script> 
<div>
<%
  ...
  url="screen.do?method=grpcomparasionPiePrpWiseMix&graphby=VLU&filterlprp="+vwPrpLst.get(0);
