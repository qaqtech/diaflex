...
<html>
  <head>
     <%
  ArrayList  dtlList = (ArrayList)request.getAttribute("dtlList_consignmentsale");
  String hdrnme = (String)request.getAttribute("hdrnme_consignmentsale");
   String  consignmentsalerfsh = (String)request.getAttribute("consignmentsalerfsh");
  String  view = (String)request.getAttribute("view");
   int defaultdisplay=5;
   String url="ajaxdashAction.do?method=dashbuyerwisePieChart&defaultdisplay="+defaultdisplay;
   String style="width: 55%; height: 362px; "; 
   String styleId="CSL_DIV";
   String title="Daily Consignment Sale Report";
