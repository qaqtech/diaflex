...
<html>
  <head>
     <%
ArrayList  dtlList = (ArrayList)request.getAttribute("dtlList_BRC");
  String hdrnme = (String)request.getAttribute("hdrnme_BRC");
   String  ddlvrfsh = (String)request.getAttribute("dbrcrfsh");
  String  view = (String)request.getAttribute("view");
   ...
   String title="Daily Branch Delivery Report";
...
<%if(view.equals("Y")){
  ...
  <tr>
  <th>Buyer</th><th>Qty</th><th>Cts</th><th>Value</th>
  </tr>
