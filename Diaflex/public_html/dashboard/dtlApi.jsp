...
<html>
  <head>
       <%
  ArrayList itemHdr = (ArrayList)request.getAttribute("itemHdrwebapi");
  ArrayList dtlsList = (ArrayList)request.getAttribute("dtlListwebapi");
  String hdrnme = (String)request.getAttribute("hdrnmewebapi");
   String  webrfsh = (String)request.getAttribute("webapirfsh");%>
    <title>Web Login Dtl(Api) </title>
