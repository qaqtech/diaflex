...
<html>
  <head>
     <%
  ArrayList  dtlList = (ArrayList)request.getAttribute("dtlList_sale");
  String hdrnme = (String)request.getAttribute("hdrnme_sale");
   String  dsalerfsh = (String)request.getAttribute("dsalerfsh");
   String  view = (String)request.getAttribute("view");
   String url="ajaxdashAction.do?method=dashbuyerwisePieChart&defaultdisplay=5";
   String style="width: 55%; height: 362px; "; 
   String styleId="SL_DIV";
   String title="Daily Sale Report";
