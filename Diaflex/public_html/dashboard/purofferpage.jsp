...
<html>
  <head>
     <%
ArrayList  dtlList = (ArrayList)request.getAttribute("dtlList_O");
  String hdrnme = (String)request.getAttribute("hdrnme_O");
   String  purofferrfsh = (String)request.getAttribute("purofferrfsh");
...
<%if(view.equals("Y")){
  ...
  <tr>
  <th nowrap="nowrap">Vender</th><th>Qty</th><th>Avg</th><th>Cts</th><th>Value</th>
  </tr>
  ...
  byrdata=(HashMap)dtlList.get(i);
   %>
 <tr>
   <td ><%=util.nvl((String)byrdata.get("NME"))%></td>
   <td align="center"><%=util.nvl((String)byrdata.get("QTY"))%></td>
    <td align="center"><%=util.nvl((String)byrdata.get("AVG"))%></td>
    <td align="center"><%=util.nvl((String)byrdata.get("CTS"))%></td>
    <td align="center"><%=util.nvl((String)byrdata.get("VLU"))%></td>
  </tr>
  <%}%>
  </table></div>
  </td></tr>
