...
function showCalender(elPos, tgtEl)
{
    ...
    if(myMonth=="FEB"){myMonth="02";}
     if(myMonth=="MAR"){myMonth="03";}
      if(myMonth=="APR"){myMonth="04";}
       if(myMonth=="MAY"){myMonth="05";}
        if(myMonth=="JUN"){myMonth="06";}
         if(myMonth=="JUL"){myMonth="07";}
          if(myMonth=="AUG"){myMonth="08";}
           if(myMonth=="SEP"){myMonth="09";}
            if(myMonth=="OCT"){myMonth="10";}
             if(myMonth=="NOV"){myMonth="11";}
              if(myMonth=="DEC"){myMonth="12";}
   
   var Datestr = myDay + "-" + myMonth + "-" + myYear;

   var m = matchDate.exec(Datestr);
...
montharray=new Array('JAN','FEB','MAR','APR','MAY','JUN','JUL','AUG','SEP','OCT','NOV','DEC');
	...
	{
		targetEl.value= day+'-'+montharray[month-1]+'-'+year;
		closeCalender();
	}
        targetEl.focus();
}
