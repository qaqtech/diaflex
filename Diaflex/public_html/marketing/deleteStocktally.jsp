...
<html>
 ...
 <body onfocus="<%=onfocus%>">
   <%
ArrayList seqList = (session.getAttribute("seqLst") == null)?new ArrayList():(ArrayList)session.getAttribute("seqLst");
%>
<table>
  <%
...
<%if(seqList.size()>0){%>
<tr>
  <html:form action="marketing/newStockTally.do?method=delete" method="post" >
