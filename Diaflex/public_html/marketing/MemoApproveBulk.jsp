...
<html>
  <head>
    ...
    <title>Approve Memo Return</title>
...
<table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0" class="mainbg">
  ...
  <img src="../images/line.jpg" border="0" /></td><td valign="middle"> <span class="pgHed">Approve Memo Return In Bulk</span> </td>
</tr></table>
  </td>
  </tr>
  ...
  <html:form action="/marketing/memoApproveBulkReturn.do?method=load"  method="POST">
  <html:hidden property="value(listname)" styleId="listname" value="vnmLst" />
        ...
        <tr><th colspan="2">Memo Search </th></tr>
            ...
            <tr>
            <td>Packets. </td><td>
            <html:textarea property="value(vnmLst)" cols="30" styleId="vnmLst" name="memoReturnBulkForm" />
...
<%}%>
  ...
  <tr><td valign="top" class="tdLayout">
    <html:form action="/marketing/memoApproveBulkReturn.do?method=save" method="POST" onsubmit="return confirmChangesWithPopup()" >
  ...
  String isRd = "ALLRedioBK('isRd' ,'AP_','"+memoIdn+"')";
  ...
  <tr><td>
     <table class="grid1">
                <tr>
                    <th>Sr</th>
                     <th><html:radio property="value(slRd)"  styleId="<%=isRdId%>"  onclick="<%=isRd%>"  value="AP"/>&nbsp;Approve</th>
               ...
               int count = 0;
                ...
                <%    
                   count=i+1;
                    ...
                    String rdSTId = "AP_"+count+"_"+memoIdn;
                    String rdRTId = "RT_"+count+"_"+memoIdn;                   
                %>
                <td><html:radio property="<%=sttPrp%>" styleId="<%=rdSTId%>" name="memoReturnBulkForm" value="AP"/></td>
