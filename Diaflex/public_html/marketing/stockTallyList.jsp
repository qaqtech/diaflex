 ...
 <body onfocus="<%=onfocus%>">
  ...
  <table>
   ...
   if(stockList!=null && stockList.size()>0){
    ...
    itemHdr.add("stt");
   %>
  <tr><td>Create Excel <img src="../images/ico_file_excel.png" border="0" onclick="goTo('<%=info.getReqUrl()%>/marketing/newStockTally.do?method=createXLstocktally')"/>
</td>
   </tr>
   <tr><td>
