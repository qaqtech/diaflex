...
<html>
 ...
 <body onfocus="<%=onfocus%>">
    ...
    <tr>
 <td>
  <html:form styleId="multi" action="marketing/StockSearch.do?method=multiImgSend" method="post" onsubmit="return checkBoxVald();" >
<html:hidden property="value(flg)" name="searchForm" styleId="flg"/>
<html:hidden property="value(where)" name="searchForm" styleId="where"/>
<table>
<tr>
<td>
<table>
<tr>
<td>Subject</td><td><html:textarea property="value(subject)" name="searchForm" styleId="subject"/></td>
</tr>
<tr>
<td>To</td><td><html:text property="value(to_eml)" name="searchForm" size="40" styleId="to_eml"/></td>
</tr>
<tr>
<td>cc</td><td><html:text property="value(cc_eml)" name="searchForm" size="40" styleId="cc_eml"/></td>
</tr>
<tr>
<td>bcc</td><td><html:text property="value(bcc_eml)" name="searchForm" size="40" styleId="bcc_eml"/></td>
</tr>
</table>
</td>
</tr>
