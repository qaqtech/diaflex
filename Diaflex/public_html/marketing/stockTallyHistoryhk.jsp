...
<table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0" class="mainbg">
  ...
  <%}%>
   ...
   <table><tr><td>
   <html:form action="marketing/stockTallyhk.do?method=history" method="post" >
  <table  class="grid1">
 ...
 <html:option value="0" >---select---</html:option>
  ...
  %>
   <tr><td><b><A href="<%=info.getReqUrl()%>/marketing/stockTallyhk.do?method=TallyCRTHistory&stt=<%=mstkStt%>&loadSeq=<%=loadSeq%>&issdte=<%=issdte%>&rtndte=<%=rtndte%>" onclick="displayover('pktDtltd')"  target="pktDtl"><%=util.nvl((String)grp3list.get(mstkStt))%></a> </b> </td>
  
   <td><A href="<%=info.getReqUrl()%>/marketing/stockTallyhk.do?method=PktDtlHistory&dfstt=<%=mstkStt%>&issTyp=ALL&loadSeq=<%=loadSeq%>&issdte=<%=issdte%>&rtndte=<%=rtndte%>" target="_blank"><%=ttlQ%> </a></td>
   <td><%=ttlC%></td>
   <td><A href="<%=info.getReqUrl()%>/marketing/stockTallyhk.do?method=PktDtlHistory&dfstt=<%=mstkStt%>&issTyp=IS&loadSeq=<%=loadSeq%>&issdte=<%=issdte%>&rtndte=<%=rtndte%>" target="_blank"><%=util.nvl((String)pktDtl.get(mstkStt+"_IS_Q"))%></a></td>
   <td><%=util.nvl((String)pktDtl.get(mstkStt+"_IS_C"))%></td>
   <td><A href="<%=info.getReqUrl()%>/marketing/stockTallyhk.do?method=PktDtlHistory&dfstt=<%=mstkStt%>&issTyp=RT&loadSeq=<%=loadSeq%>&issdte=<%=issdte%>&rtndte=<%=rtndte%>" target="_blank"><%=util.nvl((String)pktDtl.get(mstkStt+"_RT_Q"))%></a></td>
  ...
  <td valign="top" style="display:none;" id="pktDtltd">
   <iframe name="pktDtl" width="500" frameborder="0">
