...
<html:form action="pricing/pricegp.do?method=save" method="post">
<table class="grid1" >
...
<td>&nbsp;</td>
<%} else {
            String link1="/pricing/pricegpdef.do?method=load&nme="+ fldId ;
        %>
        <td nowrap="nowrap"><html:link page="<%=link1%>">Add Properties </html:link></td>
        <%}%>
