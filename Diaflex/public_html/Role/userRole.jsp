...
<table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0" class="mainbg">
 ...
 <table class="grid1" width="400">
 <tr><th colspan="2">Role Details</th></tr>
  <%for(int i=0;i<roleList.size();i++){
  Role roleDtl = (Role)roleList.get(i);
  String roleIdn = String.valueOf(roleDtl.getRoleIdn());
  String fldValue = "value("+roleIdn+")" ;
  String onChanges = "SaveRole("+roleIdn+","+usrIdn+",this)";
  %>
   <tr><td> <html:checkbox  property="<%=fldValue%>" value="<%=roleIdn%>" onchange="<%=onChanges%>" name="userRoleForm"  /></td><td> <%=roleDtl.getRole_dsc()%></td>
  <%}%>
