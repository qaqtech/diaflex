...
<table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0" class="mainbg">
  ...
  <%
    ...
    String formAction = "/masters/dayTerms.do?method=save";
  %>
<tr>
...
<%}%>
    ...
    <%
        ...
        String getEditList = " select idn from mtrms where till_dt is null order by dys " ;
      ...
      <%
        ...
        <%} else {
            ...
            String link = url+"/masters/dayTerms.do?method=delete&id="+ lFldId ;
