...
<bean:write property="reportNme" name="groupWiseForm" />
  ...
  <tr><td valign="top" class="hedPg">Create Excel <img src="../images/ico_file_excel.png" title="Click here to Generate Excel" onclick="goToCreateXl('groupGrp.do?method=createGridXL&excelNm=ShapeSize&Report=SH')" border="0"/>&nbsp; 
  ...
  %>
   <td align="right" style="padding:0px"><span><a  title="Color Purity report" href="groupGrp.do?method=loadCOPU&group=<%=group%>&lab=<%=lab%>&stt=<%=stt%>&sh=<%=sh%>&sz=<%=sz%>&loc=<%=locS%>&valueDisplay=<%=valueDisplay%>&mlot=<%=mlot%>" ><%=Qty%></a></span></td>
  <td align="right" style="padding:0px"><span id="CTS_<%=j%>_<%=k%>" style="display:none;"><a title="Packet Details" target="_blank"  href="groupGrp.do?method=pktDtl&group=<%=group%>&lab=<%=lab%>&stt=<%=stt%>&sh=<%=sh%>&sz=<%=sz%>&loc=<%=locS%>&valueDisplay=<%=valueDisplay%>&mlot=<%=mlot%>" ><%=Cts%></a></span></td>
  ...
  %>
  <td align="right" style="padding:0px"><span><a  title="Color Purity report" href="groupGrp.do?method=loadCOPU&group=<%=group%>&lab=<%=lab%>&stt=<%=stt%>&sh=<%=sh%>&sz=ALL&loc=<%=locS%>&valueDisplay=<%=valueDisplay%>&mlot=<%=mlot%>" ><%=Qty%></a></span></td>
  <td align="right" style="padding:0px"><span id="TOTALCTS_<%=j%>" style="display:none;"><a title="Packet Details" target="_blank"  href="groupGrp.do?method=pktDtl&group=<%=group%>&lab=<%=lab%>&stt=<%=stt%>&sh=<%=sh%>&sz=ALL&loc=<%=locS%>&valueDisplay=<%=valueDisplay%>&mlot=<%=mlot%>" ><%=Cts%></a></span></td>
  ...
  %>
  <td align="right" style="padding:0px"><span><a  title="Color Purity report" href="groupGrp.do?method=loadCOPU&group=<%=group%>&lab=<%=lab%>&stt=<%=stt%>&sh=ALL&sz=<%=sz%>&loc=<%=locS%>&valueDisplay=<%=valueDisplay%>&mlot=<%=mlot%>" ><%=Qty%></a></span></td>
  <td align="right" style="padding:0px"><span id="TTLCTS_<%=i%>" style="display:none;"><a title="Packet Details" target="_blank"  href="groupGrp.do?method=pktDtl&group=<%=group%>&lab=<%=lab%>&stt=<%=stt%>&sh=ALL&sz=<%=sz%>&loc=<%=locS%>&valueDisplay=<%=valueDisplay%>&mlot=<%=mlot%>" ><%=Cts%></a></span></td>
  ...
  %>
  <td align="right" style="padding:0px"><span><a  title="Color Purity report" href="groupGrp.do?method=loadCOPU&group=<%=group%>&lab=<%=lab%>&stt=<%=stt%>&sh=ALL&sz=ALL&loc=<%=locS%>&valueDisplay=<%=valueDisplay%>&mlot=<%=mlot%>" ><%=Qty%></a></span></td>
  <td align="right" style="padding:0px"><span id="GTTLCTS" style="display:none;"><a title="Packet Details" target="_blank"  href="groupGrp.do?method=pktDtl&group=<%=group%>&lab=<%=lab%>&stt=<%=stt%>&sh=ALL&sz=ALL&loc=<%=locS%>&valueDisplay=<%=valueDisplay%>&mlot=<%=mlot%>" ><%=Cts%></a></span></td>
