...
public class LoyaltyCtgAction extends DispatchAction {
    private final String formName   = "loyaltyctgform";

    public LoyaltyCtgAction() {
        super();
    }
    ...
    public ActionForward save(ActionMapping am, ActionForm af, HttpServletRequest req, HttpServletResponse res)
        ...
        if(!rtnPg.equals("sucess")){
            ...
            util.updAccessLog(req,res,"Loyalty Ctg", "save start");
        ...
        LoyaltyCtgFrom udf = (LoyaltyCtgFrom) af;
        ...
        if (udf.getAddnew() != null) {
            ...
            for (int i = 1; i <= lmt; i++) {
                ...
                String insIntoQ = " insert into loyalty_ctg ( idn ";
                String insValQ  = "values(LOYALTY_CTG_SEQ.nextval ";
        ...
        if (udf.getModify() != null) {
            ...
            String    getMenu = "select " + helper.getSrchFields(daos, "idn", false) + " from LOYALTY_CTG  ";
            ArrayList    params  = new ArrayList();
            ResultSet rs      = db.execSql("getUIFormFields for update", getMenu, params);

            while (rs.next()) {
                int    lIdn  = rs.getInt(1);
                String updQ  = " update loyalty_ctg set idn = idn ";
        ...
        req.setAttribute("errors", errorList);
            util.updAccessLog(req,res,"Loyalty Ctg", "save end");
    ...
    public ActionForward load(ActionMapping am, ActionForm af, HttpServletRequest req, HttpServletResponse res)
        ...
        if(!rtnPg.equals("sucess")){
            ...
            util.updAccessLog(req,res,"Loyalty Ctg", "load start");
            HashMap  formFields = info.getFormFields(formName);
        ...
        util.updAccessLog(req,res,"Loyalty Ctg", "load end");
    ...
    public String init(HttpServletRequest req , HttpServletResponse res,HttpSession session,DBUtil util) {
            ...
            System.out.print("New Session Id :="+session.getId());
                ...
                util.updAccessLog(req,res,"Loyalty Ctg", "Unauthorized Access");
                else
                util.updAccessLog(req,res,"Loyalty Ctg", "init");
            }
            }
            return rtnPg;
         }
