...
<html>
  <head>
    ...
    <title>Manual Price Change</title>
...
<table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0" class="mainbg">
  ...
  <%
   ArrayList params = new ArrayList();
    ...
    String formName = "mpchangeform";
    util.updAccessLog(request,response,"Manual Price Change", "Manual Price Change");
    ...
    String formAction = "/pricing/mpchange.do?method=save";
 %>
 <tr>
