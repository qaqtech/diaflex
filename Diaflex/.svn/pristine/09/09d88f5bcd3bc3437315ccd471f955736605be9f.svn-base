...
public class McurrenciesAction extends DispatchAction {
    private final String formName   = "currencies";


    public McurrenciesAction() {
        super();
    }
    ...
    public ActionForward save(ActionMapping am, ActionForm af, HttpServletRequest req, HttpServletResponse res)
        ...
        if(!rtnPg.equals("sucess")){
            ...
            util.updAccessLog(req,res,"Currencies form", "save start");
        ...
        McurrenciesForm udf = (McurrenciesForm) af;
        ...
        if (udf.getAddnew() != null) {
            ...
            for (int i = 1; i <= lmt; i++) {
                ...
                String insIntoQ = " insert into mcur (cur_idn ";
                String insValQ  = "values(cur_seq.nextval ";
        ...
        if (udf.getModify() != null) {
            ...
            String    getMenu = "select " + helper.getSrchFields(daos, "cur_idn", false) + " from mcur  ";
            ArrayList    params  = new ArrayList();
            ResultSet rs      = db.execSql("getUIFormFields for update", getMenu, params);

            while (rs.next()) {
                int    lIdn  = rs.getInt(1);
                String updQ  = " update mcur set cur_idn = cur_idn ";
                String condQ = " where cur_idn = ? ";
                boolean isValid = false;
        ...
        req.setAttribute("errors",errorList);
            util.updAccessLog(req,res,"Currencies form", "save end");
    ...
    public ActionForward load(ActionMapping am, ActionForm af, HttpServletRequest req, HttpServletResponse res)
        ...
        if(!rtnPg.equals("sucess")){
            ...
            util.updAccessLog(req,res,"Currencies form", "load start");
            HashMap  formFields = info.getFormFields(formName);
        ...
        String srchFields = helper.getSrchFields(daos, "cur_idn");
        String srchQ      = " ";

        // helper.getSrchList(uiForms, frmTbl, srchFields, srchQ, params, daos, typ)
        ArrayList list = helper.getSrchList(uiForms, "mcur", srchFields, srchQ, new ArrayList(), daos, "VIEW");
        ...
        util.updAccessLog(req,res,"Currencies form", "load end");
    ...
    public String init(HttpServletRequest req , HttpServletResponse res,HttpSession session,DBUtil util) {
            ...
            System.out.print("New Session Id :="+session.getId());
                ...
                util.updAccessLog(req,res,"Currencies form", "Unauthorized Access");
                else
                util.updAccessLog(req,res,"Currencies form", "init");
            }
            }
            return rtnPg;
         }
