package ft.com.mix;
import ft.com.marketing.MemoSaleFrm;
...
public class MixDeliveryReturnForm extends ActionForm {
    private int       nmeIdn, relIdn,
                      saleIdn = 0 , invTrmsIdn , invByrIdn , invAddrIdn;
    ...
    public void setSaleIdn(int saleIdn) {
        this.saleIdn = saleIdn;
    }

    public int getSaleIdn() {
        return saleIdn;
    }
}
