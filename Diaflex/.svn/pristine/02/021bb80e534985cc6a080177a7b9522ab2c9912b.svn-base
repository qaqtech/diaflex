...
<table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0" class="mainbg">
  ...
  <%
   ArrayList params = new ArrayList();
    ...
    String formAction = "/pricing/pricegpdef.do?method=save";
 %>
 <tr>
...
<%
    ...
    for(int dsp=0; dsp < dspOrder.size(); dsp++) {
      ...
      <%
        ...
        %>
        <td nowrap="nowrap"><a onClick="priceGPPrp('pricegpprpdef.do?method=load&nme=<%=fldId%>','<%=fldId%>')" id="anchor">Add Properties</a></td>
        <%}%>
