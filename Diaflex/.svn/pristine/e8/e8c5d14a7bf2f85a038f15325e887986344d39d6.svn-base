...
import org.apache.struts.action.ActionForm;
    ...
    public class InsGrpAction extends DispatchAction {
        private final String formName   = "insurancegrp";
        ...
        public ActionForward save(ActionMapping am, ActionForm af, HttpServletRequest req, HttpServletResponse res)
            ...
            if(!rtnPg.equals("sucess")){
                ...
                util.updAccessLog(req,res,"Insurance grp", "save start");
            ...
            if (udf.getAddnew() != null) {
                ...
                for (int i = 1; i <= lmt; i++) {
                    ...
                    String insIntoQ = " insert into ins_grp (ins_grp_idn ";
                    String insValQ  = "values(ins_grp_seq.nextval";
            ...
            if (udf.getModify() != null) {
                ...
                String    getMenu = "select " + helper.getSrchFields(daos, "ins_grp_idn", false) + " from ins_grp where vld_dte is null order by ins_grp_nme  ";
                ArrayList    params  = new ArrayList();
                ResultSet rs      = db.execSql("getUIFormFields for update", getMenu, params);

                while (rs.next()) {
                    int    lIdn  = rs.getInt(1);
                    String updQ  = " update ins_grp set ins_grp_idn = ins_grp_idn ";
                    String condQ = " where ins_grp_idn = ? ";
                    boolean isValid = false;
            ...
            req.setAttribute("errors", errorList);
                util.updAccessLog(req,res,"Insurance grp", "save end");
        ...
        public ActionForward load(ActionMapping am, ActionForm af, HttpServletRequest req, HttpServletResponse res)
            ...
            if(!rtnPg.equals("sucess")){
                ...
                util.updAccessLog(req,res,"Insurance grp", "load start");
                HashMap  formFields = info.getFormFields(formName);
            ...
            String srchFields = helper.getSrchFields(daos, "ins_grp_idn");
            String srchQ      = " ";
            ...
            // udf = (InsGrpFrm)helper.getForm(uiForms, "", srchFields, srchQ, new ArrayList(), daos, "VIEW") ;
            req.setAttribute(formName, list);

            // udf.setList(list);
            // info.setNmeSrchList(list);
           
            util.updAccessLog(req,res,"Insurance grp", "load end");
            return am.findForward("insgrp");
            }
        }
      public ActionForward delete(ActionMapping am, ActionForm af, HttpServletRequest req, HttpServletResponse res)
          ...
          if(!rtnPg.equals("sucess")){
              ...
              util.updAccessLog(req,res,"Insurance grp", "delete start");
          InsGrpFrm udf = (InsGrpFrm) af;

          int    idn  = udf.getId();
          String delQ = " delete from ins_grp where ins_grp_idn = ? ";
          ArrayList ary  = new ArrayList();

          ary.add(String.valueOf(idn));

          int ct = db.execUpd(" del trms", delQ, ary);
              util.updAccessLog(req,res,"Insurance grp", "delete end");
          return load(am, af, req, res);
          }
      }
        ...
        public String init(HttpServletRequest req , HttpServletResponse res,HttpSession session,DBUtil util) {
                ...
                System.out.print("New Session Id :="+session.getId());
                    ...
                    util.updAccessLog(req,res,"Insurance grp", "Unauthorized Access");
                    else
                    util.updAccessLog(req,res,"Insurance grp", "init");
                }
                }
                return rtnPg;
             }
