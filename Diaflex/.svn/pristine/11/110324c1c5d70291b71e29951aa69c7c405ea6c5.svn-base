...
<table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0" class="mainbg">
  ...
  <%
   ArrayList params = new ArrayList();
    ...
    String formAction = "/masters/department.do?method=save";
 %>
 <tr>
...
<%
    ...
    for(int dsp=0; dsp < dspOrder.size(); dsp++) {
      ...
      <%
        ...
        <td>&nbsp;</td>
        <%} else {
           String link1="/masters/deptToProcessAction.do?method=load&deptIdn="+ fldId ;
             String link2="/masters/deptToEmpAction.do?method=load&deptIdn="+ fldId ;
        %>
        <td nowrap="nowrap"><html:link page="<%=link1%>" target="frame">Add Process </html:link> |<html:link page="<%=link2%>" target="frame"> Add Employee</html:link></td>
        <%}%>
        </tr>  
    <%}
%>    
...
<%  }%>
    ...
    <td valign="top">
      <iframe name="frame" height="1000" width="600" frameborder="0" >
