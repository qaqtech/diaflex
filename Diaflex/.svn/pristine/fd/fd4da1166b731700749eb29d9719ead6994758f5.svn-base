...
public class RoleAction  extends DispatchAction {
    private final String formName   = "dfrole";
    public RoleAction() {
        super();
    }
    ...
    public ActionForward load(ActionMapping am, ActionForm af, HttpServletRequest req, HttpServletResponse res)
        ...
        if(!rtnPg.equals("sucess")){
            ...
            util.updAccessLog(req,res,"Role Detail", "load start");
        ...
        String srchFields = helper.getSrchFields(daos, "DF_ROLE_IDN");
        String srchQ      = " ";
        ...
        util.SOP(" NmeSearch Count : " + list.size());
            util.updAccessLog(req,res,"Role Detail", "load end");
    ...
    public ActionForward save(ActionMapping am, ActionForm af, HttpServletRequest req, HttpServletResponse res)
        ...
        if(!rtnPg.equals("sucess")){
            ...
            util.updAccessLog(req,res,"Role Detail", "save start");
            HashMap  formFields = info.getFormFields(formName);
        ...
        if (udf.getAddnew() != null) {
            ...
            for (int i = 1; i <= lmt; i++) {
                ...
                String insIntoQ = " insert into df_mrole ( df_role_idn ";
                String insValQ  = "values(DF_ROLE_ID_SEQ.nextval ";
        ...
        if (udf.getModify() != null) {
            ...
            String    getMenu = "select " + helper.getSrchFields(daos, "DF_ROLE_IDN", false) + " from df_mrole  ";
            ArrayList    params  = new ArrayList();
            ...
            while (rs.next()) {
                ...
                String updQ  = " update df_mrole set DF_ROLE_IDN = DF_ROLE_IDN ";
                String condQ = " where DF_ROLE_IDN = ? ";
                boolean isValid = false;
        ...
        req.setAttribute("errors", errorList);
            util.updAccessLog(req,res,"Role Detail", "save end");
    ...
    System.out.print("New Session Id :="+session.getId());
        ...
        util.updAccessLog(req,res,"Role Detail", "Unauthorized Access");
        else
        util.updAccessLog(req,res,"Role Detail", "save end");
    }
    }
