...
<table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0" class="mainbg">
  ...
  <img src="../images/line.jpg" border="0" /></td><td valign="middle"> <span class="pgHed">Box Sale Return</span> </td>
</tr></table>
  </td>
  </tr>
  <%
  ...
  <html:form action="box/boxSalReturn.do?method=view" method="post" onsubmit="return validteSaleIdn()" >
  ...
  <html:hidden property="value(salTyp)" name="boxSaleReturnForm" />
   <table class="grid1" >
    <tr><th colspan="2">Sale Search </th></tr>
     <tr> <td>Buyer Name :</td>
     <td>
     <html:select property="byrIdn" name="boxSaleReturnForm" onchange="getFinalByrMix(this,'SL')" styleId="byrId" >
    <html:option value="0">---select---</html:option>
    <html:optionsCollection property="byrLst" name="boxSaleReturnForm"  value="byrIdn" label="byrNme" />
     ...
     <tr> <td>Billing Party :</td>
       <td>
       <html:select property="prtyIdn" name="boxSaleReturnForm" onchange="getSaleTrmsMix(this.value , 'SL')"  styleId="prtyId"  >
        <html:option value="0">---select---</html:option>    
        </html:select>
       </td>
       </tr>
      ...
      <tr> <td>Terms :</td>
        <td>
        <html:select property="relIdn" name="boxSaleReturnForm"  onchange="getSaleIdnMix('SL')" styleId="rlnId"  >
     <html:option value="0">---select---</html:option>
</html:select>
        </td>
        </tr>   
       
    <tr> <td>Sale Ids</td><td><html:text property="value(saleIdn)" styleId="saleIdn" name="boxSaleReturnForm"/></td> </tr>    
...
<div id="memoIdn"></div>
  ...
  <html:form action="box/boxSalReturn.do?method=Return" method="post" onsubmit="return boxConfirm()" >
...
<td><html:text property="<%=qtyRtn%>"  readonly="true" styleId="<%=qtyRtnId%>" onchange="<%=onChangeQR%>" size="9" styleClass="txtStyle" name="boxSaleReturnForm" /></td>
<td><html:text property="<%=ctsRtn%>" readonly="true" size="9" styleId="<%=ctsRtnId%>" onchange="<%=onChangeCR%>" styleClass="txtStyle" name="boxSaleReturnForm" /></td>
<td><html:text property="<%=prcRtn%>" readonly="true" size="9" styleClass="txtStyle" name="boxSaleReturnForm" /></td>
<%for(int j=0; j < prps.size(); j++) {
