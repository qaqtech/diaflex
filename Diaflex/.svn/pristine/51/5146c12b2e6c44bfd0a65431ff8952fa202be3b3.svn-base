...
public class AtrDtlSubAction extends DispatchAction {
    private final String formName   = "atrdtlsubform";

    public AtrDtlSubAction() {
        super();
    }
    ...
    public ActionForward load(ActionMapping am, ActionForm af, HttpServletRequest req, HttpServletResponse res)
        ...
        if(!rtnPg.equals("sucess")){
            ...
            util.updAccessLog(req,res,"AtrDtlSub  form", "load start");
        ...
        AtrDtlSubForm udf = (AtrDtlSubForm) af;
        ...
        udf.setValue("mprp", mprp);
            ...
            HashMap pageDtl=(HashMap)allPageDtl.get("SUBDTL_FORM");
            if(pageDtl==null || pageDtl.size()==0){
            pageDtl=new HashMap();
            pageDtl=util.pagedef("SUBDTL_FORM");
            allPageDtl.put("SUBDTL_FORM",pageDtl);
            }
            util.updAccessLog(req,res,"AtrDtlSub  form", "load end");
    ...
    public ActionForward save(ActionMapping am, ActionForm af, HttpServletRequest req, HttpServletResponse res)
            throws Exception {
                ...
                if(!rtnPg.equals("sucess")){
                    ...
                    util.updAccessLog(req,res,"AtrDtlSub  form", "save end");
                    HashMap  formFields = info.getFormFields(formName);
        ...
        if (udf.getModify() != null) {
            ...
            String    getMenu = "select " + helper.getSrchFields(daos, "mprp", false) + " from prp_nme where mprp=? order by srt ";
            ArrayList    params  = new ArrayList();
            params.add(udf.getValue("mprp"));
...
//        util.initPrp();
    ...
    public String init(HttpServletRequest req , HttpServletResponse res,HttpSession session,DBUtil util) {
            ...
            System.out.print("New Session Id :="+session.getId());
                ...
                util.updAccessLog(req,res,"AtrDtlSub  form", "Unauthorized Access");
                else
                util.updAccessLog(req,res,"AtrDtlSub  form", "init");
            }
            }
            return rtnPg;
         }
