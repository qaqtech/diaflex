 ...
 <body onfocus="<%=onfocus%>">
  ...
  <th class="Orangeth" align="center" nowrap="nowrap">Avg Price</th><th class="Orangeth" align="center" nowrap="nowrap">Avg disc</th>
   ...
   <%if(byrempcmp.equals("Y")){%>
    <th class="Orangeth" align="center" nowrap="nowrap">Net Avg Price</th>
    <th class="Orangeth" align="center" nowrap="nowrap">Compared Prp Avg</th>
    <th class="Orangeth" align="center" nowrap="nowrap">Pl%</th>
   <%}}%>
   </tr>
  <%
  ...
  HashMap summDtl = (HashMap)summaryList.get(i);
   ...
   <%}%>
    ...
    <td align="right"><%=summDtl.get("pl")%></td>
       <%if(byrempcmp.equals("Y")){%>
    <td align="right"><%=summDtl.get("netavg")%></td>
    <td align="right"><%=summDtl.get("trfcmpavg")%></td>
    <td align="right"><%=summDtl.get("plpertrfCmp")%></td>
   <%}}%>
 </tr>
  <%}}%>
  </table>
  ...
  <tr>
  <td></td>
  <td align="center" nowrap="nowrap" title="Quantity">Qty</td>
  <td align="center" nowrap="nowrap" title="Crtwt">Cts</td>
  <td align="center" nowrap="nowrap" title="Sale Vlu">Est Vlu</td>
  <td align="center" nowrap="nowrap" title="Net Sale Vlu">Net Est Vlu</td>
  <% if(net_pur.equals("Y")){%>
  <td align="center" nowrap="nowrap" title="Cost Price(Actual Net Purchase Rate)">Cp</td>
  <td align="center" nowrap="nowrap"  title="Cost Value(Actual Net Purchase Rate)">Cp Vlu</td>
  <%}%>
  <td align="center" nowrap="nowrap" title="Quantity">Qty</td>
  <td align="center" nowrap="nowrap" title="Crtwt">Cts</td>
  <td align="center" nowrap="nowrap" title="Sale Vlu">Est Vlu</td>
  ...
  <td align="center" nowrap="nowrap" title="Cost Price(Actual Net Purchase Rate)">Cp</td>
  <td align="center" nowrap="nowrap"  title="Cost Value(Actual Net Purchase Rate)">Cp Vlu</td>
  <td align="center" nowrap="nowrap" title="Profit Value">Pl Vlu</td>
  <td align="center" nowrap="nowrap" title="Profit %">Pl %</td>
  <%}%>
  <td align="center" nowrap="nowrap" title="Quantity">Qty</td>
  <td align="center" nowrap="nowrap" title="Crtwt">Cts</td>
  <td align="center" nowrap="nowrap" title="Sale Vlu">Est Vlu</td>
  ...
  if(!newsoldValpvluVlu.equals(""))
    newSoldpvluVlu = Double.parseDouble(newsoldValpvluVlu); 
     ...
     closeValpvluVlu = (openingValpvluVlu + newValdoupvluVlu)-soldValdoupvluVlu-newSoldpvluVlu;
     OPENSTR_PURVLU = closeValpvluVlu;
     
     openingValprteVlu = OPENSTR_PURAVG;
     closeValprteVlu = closeValpvluVlu/closeValCts;
  ...
  <td align="right"  title="Quantity"><%=openingVal%></td>
  <td align="right" title="Crtwt"><%=util.Round(openingValCts,2)%></td>
    <td align="right" title="Sale Vlu"><%=Math.round(openingValVlu)%></td>
      <td align="right" title="Net Sale Vlu"><%=Math.round(openingValNetVlu)%></td>
       <% if(net_pur.equals("Y")){%>
           <td align="right" title="Cost Price(Actual Net Purchase Rate)"><%=Math.round(openingValprteVlu)%></td>
      <td align="right" title="Cost Value(Actual Net Purchase Rate)"><%=Math.round(openingValpvluVlu)%></td>
       <%}%>
  <td align="right" title="Quantity"><%=newValInt%></td>
  <td align="right" title="Crtwt"><%=util.Round(newValdouCts,2)%></td>
    <td align="right" title="Sale Vlu"><%=Math.round(newValdouVlu)%></td>
      <td align="right" title="Net Sale Vlu"><%=Math.round(newValdouNetVlu)%></td>
         <% if(net_pur.equals("Y")){%>
    <td align="right" title="Cost Price(Actual Net Purchase Rate)"><%=Math.round(newValdouprteVlu)%></td>
      <td align="right" title="Cost Value(Actual Net Purchase Rate)"><%=Math.round(newValdoupvluVlu)%></td>
       <%}%>
  <td align="right" title="Quantity"><%=newSold%></td>
  <td align="right" title="Crtwt"><%=util.Round(newSoldCts,2)%></td>
    <td align="right" title="Sale Vlu"><%=Math.round(newSoldVlu)%></td>
      <td align="right" title="Net Sale Vlu"><%=Math.round(newSoldNetVlu)%></td>
           <% if(net_pur.equals("Y")){%>
    <td align="right" title="Cost Price(Actual Net Purchase Rate)"><%=Math.round(newSoldprteVlu)%></td>
      <td align="right" title="Cost Value(Actual Net Purchase Rate)"><%=Math.round(newSoldpvluVlu)%></td>
                  <td align="right" title="Profit Value"><%=Math.round(newSoldNetVlu-newSoldpvluVlu)%></td>
                  <td align="right" title="Profit %"><%=Math.round(((newSoldNetVlu-newSoldpvluVlu)/newSoldpvluVlu)*100)%></td>
       <%}%>
  <td align="right" title="Quantity"><%=soldValInt%></td>
  <td align="right" title="Crtwt"><%=util.Round(soldValdouCts,2)%></td>
    <td align="right" title="Sale Vlu"><%=Math.round(soldValdouVlu)%></td>
      <td align="right" title="Net Sale Vlu"><%=Math.round(soldValdouNetVlu)%></td>
             <% if(net_pur.equals("Y")){%>
    <td align="right" title="Cost Price(Actual Net Purchase Rate)"><%=Math.round(soldValdouprteVlu)%></td>
      <td align="right" title="Cost Value(Actual Net Purchase Rate)"><%=Math.round(soldValdoupvluVlu)%></td>
                        <td align="right" title="Profit Value"><%=Math.round(soldValdouNetVlu-soldValdoupvluVlu)%></td>
                        <td align="right" title="Profit %"><%=Math.round(((soldValdouNetVlu-soldValdoupvluVlu)/soldValdoupvluVlu)*100)%></td>
       <%}%>
  <td align="right" title="Quantity"><%=closeVal%></td>
  <td align="right" title="Crtwt"><%=util.Round(closeValCts,2)%></td>
    <td align="right" title="Sale Vlu"><%=Math.round(closeValVlu)%></td>
      <td align="right" title="Net Sale Vlu"><%=Math.round(closeValNetVlu)%></td>
                   <% if(net_pur.equals("Y")){%>
    <td align="right" title="Cost Price(Actual Net Purchase Rate)"><%=Math.round(closeValprteVlu)%></td>
      <td align="right" title="Cost Value(Actual Net Purchase Rate)"><%=Math.round(closeValpvluVlu)%></td>
       <%}%>
 </tr>
  <%}
  ...
  newValdouTotalprteVlu=newValdouTotalpvluVlu/newValdouTotalCts;
  double newSoldTotalprteVlu = 0;
  newSoldTotalprteVlu=newValdouTotalpvluVlu/newValdouTotalCts;
  double soldValdouTotalprteVlu =0;
  soldValdouTotalprteVlu=soldValdouTotalpvluVlu/soldValdouTotalCts;
  double closeValTotalprteVlu =0;
  closeValTotalprteVlu=closeValTotalpvluVlu/closeValTotalCts;
