...
<html>
  <head>
    ...
    <title>Mfg File Seq Log Details</title>
...
<table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0" class="mainbg">
  ...
  <%
   ArrayList params = new ArrayList();
    ResultSet rs = null;
    String formName = "mfgfileseqform";
    ...
    int addRec = Integer.parseInt(util.nvl("3","10"));
    String formAction = "/masters/mfgFileSeqLogAction.do?method=save";
 %>
 <tr>
    ...
    for(int dsp=0; dsp < dspOrder.size(); dsp++) {
      ...
      <%
        ...
        <%
            ...
            if(fldTyp.equals("TA")) {
            %>
                <html:textarea property="<%=fldNm%>" cols="<%=fldSz%>"/>
            <%}
        ...
        <%}else {
            ...
            String link = info.getReqUrl() + "/masters/mfgFileSeqLogAction.do?method=delete&idn="+ fldId ;
