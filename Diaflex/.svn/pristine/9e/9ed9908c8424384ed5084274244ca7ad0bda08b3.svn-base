...
<html>
  <head>
    ...
    <title>Mix Adjustment Details</title>
...
<table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0" class="mainbg">
  ...
  <%
   ArrayList params = new ArrayList();
    ...
    String formAction = "/mix/mixadj.do?method=save";
 %>
 <tr>
    ...
    for(int dsp=0; dsp < dspOrder.size(); dsp++) {
      ...
      <%
        ...
        <%}else {
            ...
            String link = info.getReqUrl() + "/mix/mixadj.do?method=delete&id="+ fldId ;
