...
<table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0" class="mainbg">
  ...
  <%
   ArrayList params = new ArrayList();
    ...
    String formName = "lapSyncMprpForm";
...
<%}%>
 ...
 <html:form action="masters/labsyncmprp.do?method=save" method="post">
    <table class="grid1" >
       ...
       <% if(msg.equalsIgnoreCase("NEW")) {%>
        ...
        <%} else {
           if (fldId.indexOf("&") > -1) {
            ...
            String link1="/masters/labsyncprp.do?method=load&mprp="+ fldId ;
        %>
        <td><html:link page="<%=link1%>" target="frame">Add Properties </html:link></td>
        <%}%>
