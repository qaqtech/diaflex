...
<%@ page import="java.util.ArrayList,java.util.HashMap,java.util.ArrayList, ft.com.assort.DeptAllocationForm, ft.com.assort.DeptAllocationAction"%>
...
<%String logId=String.valueOf(info.getLogId());
 ...
 <body onfocus="<%=onfocus%>" onload="MM_preloadImages('images/faunalogo.png');" topmargin="0" leftmargin="0" rightmargin="0" bottommargin="0">
  ...
  <tr><td>
    <html:form styleId="myform" action="assort/DeptAllocation.do?method=processForm" method="post" >
      <table width="100%">
    
      <tr><td valign="top" class="tdLayout">
        <table width="70%">
          <tr> <td><html:hidden name="deptAllocationForm" property="method" value="processForm"/></td></tr>
        </table>
      </td></tr>
      ...
      <tr><td valign="top" class="tdLayout">
        ...
        <tr> <td colspan="13">Dept. Allocation List</td> </tr>
          ...
          <tr>
            ...
            <td>
              <html:select style="width:150px;" property="<%=fldVal%>"  styleId="<%=dept%>" name="deptAllocationForm" >
            ...
            <td></td>
            <td>
              <html:select style="width:150px;" property="<%=fldThru%>"  styleId="thru_<%=i%>" name="deptAllocationForm" >
                <!---<html:option value="0" >--select--</html:option>--->
                  <html:optionsCollection property="thruList" name="deptAllocationForm" 
                  label="emp_nme" value="emp_idn" />
              </html:select>
            </td>
          </tr>
      ...
      <%
        //DeptAllocationAction d = new DeptAllocationAction();
        //String memo = d.memono(arrdept.get(0).toString(), request);
