...
public class StkCategoryAccessAction extends DispatchAction {
    private final String formName   = "stk_ctg";

        public StkCategoryAccessAction() {
        super();
    }
    ...
    public ActionForward save(ActionMapping am, ActionForm af, HttpServletRequest req, HttpServletResponse res)
        ...
        if(!rtnPg.equals("sucess")){
            ...
            util.updAccessLog(req,res,"Stock Category", "save start");
        ...
        StkCategoryAccessFrm udf = (StkCategoryAccessFrm) af;
        ...
        if (udf.getAddnew() != null) {
            ...
            for (int i = 1; i <= lmt; i++) {
                ...
                String insIntoQ = " insert into stk_ctg ( idn ";
                String insValQ  = "values(STK_CTG_SEQ.nextval ";
        ...
        if (udf.getModify() != null) {
            ...
            String    getMenu = "select " + helper.getSrchFields(daos, "idn", false) + " from stk_ctg  ";
            ArrayList    params  = new ArrayList();
            ResultSet rs      = db.execSql("getUIFormFields for update", getMenu, params);

            while (rs.next()) {
                int    lIdn  = rs.getInt(1);
                String updQ  = " update stk_ctg set idn = idn ";
        ...
        req.setAttribute("errors", errorList);
            util.updAccessLog(req,res,"Stock Category", "save end");
    ...
    public ActionForward load(ActionMapping am, ActionForm af, HttpServletRequest req, HttpServletResponse res)
        ...
        if(!rtnPg.equals("sucess")){
            ...
            util.updAccessLog(req,res,"Stock Category", "load start");
            HashMap  formFields = info.getFormFields(formName);
        ...
        // udf = (StkCategoryAccessFrm)helper.getForm(uiForms, "", srchFields, srchQ, new ArrayList(), daos, "VIEW") ;
        req.setAttribute(formName, list);

        // udf.setList(list);
        // info.setNmeSrchList(list);
     
        util.updAccessLog(req,res,"Stock Category", "load end");
  ...
  public ActionForward delete(ActionMapping am, ActionForm af, HttpServletRequest req, HttpServletResponse res)
      ...
      if(!rtnPg.equals("sucess")){
          ...
          util.updAccessLog(req,res,"Stock Category", "delete start");
      StkCategoryAccessFrm udf = (StkCategoryAccessFrm) af;

      String    idn  = util.nvl(req.getParameter("idn"));
      String delQ = " update stk_ctg set stt='IA' where idn = ? ";
      ArrayList ary  = new ArrayList();

      ary.add(idn);

      int ct = db.execUpd(" del msg", delQ, ary);
          util.updAccessLog(req,res,"Stock Category", "delete end");
      return load(am, af, req, res);
      }
  }
    ...
    public String init(HttpServletRequest req , HttpServletResponse res,HttpSession session,DBUtil util) {
            ...
            System.out.print("New Session Id :="+session.getId());
                ...
                util.updAccessLog(req,res,"Stock Category", "Unauthorized Access");
                else
                util.updAccessLog(req,res,"Stock Category", "init");
            }
            }
            return rtnPg;
         }
