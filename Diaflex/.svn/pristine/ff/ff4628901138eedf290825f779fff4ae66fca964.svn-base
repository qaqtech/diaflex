...
<table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0" class="mainbg">
  ...
  <html:form action="mix/moveMixToSingle.do?method=view" method="post">
 ...
 <html:textarea property="value(vnmLst)" rows="10" name="moveMixToSingleFrom" /></td> </tr>
 <tr><td colspan="2" align="center"><html:submit property="view" value="View" styleClass="submit"/> 
  ...
  <html:form action="lab/labSelection.do?method=save" method="post"  onsubmit="return validate_issue('CHK_' , 'count')">
   <html:hidden property="value(lstNme)" styleId="lstNme"  value="<%=lstNme%>"  name="moveMixToSingleFrom" />
  <tr>
  <td valign="top" class="tdLayout">
...
<html:select property="value(commLab)"   onchange="setLabToLabLst(this , 'lab_')" name="moveMixToSingleFrom">
       <html:option value="0">---select---</html:option>
          <html:optionsCollection property="labList" name="moveMixToSingleFrom" 
...
<td align="center">
<html:checkbox property="<%=checkFldVal%>" styleId="<%=checkFldId%>" name="moveMixToSingleFrom" onclick="<%=onclick%>" value="yes" /> 
...
<!--<td><html:radio property="<%=sttPrp%>" name="moveMixToSingleFrom"  styleId="<%=noneID%>" value="None"/></td>
<td><html:radio property="<%=sttPrp%>" name="moveMixToSingleFrom"  styleId="<%=repID%>" value="REP"/></td>
<td><html:radio property="<%=sttPrp%>" name="moveMixToSingleFrom"  styleId="<%=mixID%>" value="MX"/></td>
<td><html:radio property="<%=sttPrp%>" name="moveMixToSingleFrom"  styleId="<%=proID%>" value="PRO"/></td>-->
...
pageList= ((ArrayList)pageDtl.get("RADIOBODY") == null)?new ArrayList():(ArrayList)pageDtl.get("RADIOBODY");
        ...
        <td><html:radio property="<%=fld_nme%>" name="<%=form_nme%>" styleId="<%=fld_typ%>" value="<%=fld_ttl%>"/></td>
          <%}}
    %>       
<td><html:radio property="<%=sttPrp%>" name="moveMixToSingleFrom" styleId="<%=lbID%>" value="LB"/> 

<html:select property="<%=labVal%>"   styleId="<%=labIdn%>" name="moveMixToSingleFrom">
          <html:optionsCollection property="labList" name="moveMixToSingleFrom" 
           label="labDesc" value="labVal"  />
    </html:select>
