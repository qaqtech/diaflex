...
<table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0" >
  ...
  <%
   ArrayList params = new ArrayList();
    ...
    String keyNme = (String)info.getValue("CityCountry");
    if(pgTtl.indexOf("~") > -1)
    ...
    String formAction = "/masters/city.do?method=save";
 %>
 <tr>
  ...
  <html:hidden property="value(countryIdn)" />
    <table class="grid1">
    ...
    for(int dsp=0; dsp < dspOrder.size(); dsp++) {
      ...
      <%
        ...
        <%
            ...
            <div class="float">    
                <img src="<%=info.getReqUrl()%>/images/calender.png"  onClick="setYears(1900, <%=info.getCurrentYear()%>);showCalender(this, '<%=htmlFld%>');" /></div>
            <% }
            %>
        </td>    
        <%}%>
        ...
        <%} else {
            ...
            String link1= url+"/masters/city.do?method=delete&cityIdn="+fldId ;
