...
<%}%>
  ...
  <%}%>
    <tr><td class="tdLayout" valign="top">
 <html:form action="masters/propertyMst.do?method=save" method="post">
    <table class="grid1" >
       ...
       <% if(msg.equalsIgnoreCase("NEW")) {%>
        ...
        <%} else {
           if (fldId.indexOf("&") > -1) {
            ...
            String link1="/masters/property.do?method=load&mprp="+ fldId ;
        %>
        <td><html:link page="<%=link1%>">Add Properties </html:link></td>
        <%}%>
