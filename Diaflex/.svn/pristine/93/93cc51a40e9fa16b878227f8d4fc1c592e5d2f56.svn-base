...
<span class="txtLink" id="chart">Pie Chart</span></a>-->
 ...
 <A href="<%=info.getReqUrl()%>/report/barGraph.jsp?key=<%=replaceplus%>&col=&clr=<%=clrV%>" target="SC"  onclick="loadASSFNLPop('chart')" title="Click Here To See Bar Graph">
<img src="../images/barchart.png" id="chart" border="0" />
</a>
<A href="<%=info.getReqUrl()%>/report/commonpieChart.jsp?key=<%=replaceplus%>&col=&clr=<%=clrV%>" target="SC"  onclick="loadASSFNLPop('chart')" title="Click Here To See Pie Chart">
<img src="../images/piechart.png" id="chart" border="0" />
  ...
  <th  colspan="<%=sttLstSize*6%>">Total
   <%if(isShowgraph.equals("Y")){%>
  <A href="<%=info.getReqUrl()%>/report/barGraph.jsp?key=<%=replaceplus%>&col=&clr=ALL" target="SC"  onclick="loadASSFNLPop('chart')" title="Click Here To See Bar Graph">
<img src="../images/barchart.png" id="chart" border="0" /></a>
<A href="<%=info.getReqUrl()%>/report/commonpieChart.jsp?key=<%=replaceplus%>&col=&clr=ALL" target="SC"  onclick="loadASSFNLPop('chart')" title="Click Here To See Pie Chart">
...
<%}%>
 ...
 <%}%>
  ...
  <tr> <th><%=colV%><input type="checkbox" name="checkCol" id="<%=checkCol%>" value="<%=colV%>"/>
   <%if(isShowgraph.equals("Y")){%>
  <A href="<%=info.getReqUrl()%>/report/barGraph.jsp?key=<%=replaceplus%>&col=<%=colV%>&clr=" target="SC"  onclick="loadASSFNLPop('chart')" title="Click Here To See Bar Graph">
<img src="../images/barchart.png" border="0" id="chart"/></a>
<A href="<%=info.getReqUrl()%>/report/commonpieChart.jsp?key=<%=replaceplus%>&col=<%=colV%>&clr=" target="SC"  onclick="loadASSFNLPop('chart')" title="Click Here To See Pie Chart">
...
//     piePrpDtl.put(key+"_"+stt+"_"+colV+"_"+"COL",getcolttlqty);
  ...
  <tr><th>Total
   <%if(isShowgraph.equals("Y")){%>
  <A href="<%=info.getReqUrl()%>/report/barGraph.jsp?key=<%=replaceplus%>&col=ALL&clr=" target="SC"  onclick="loadASSFNLPop('chart')" title="Click Here To See Bar Graph">
<img src="../images/barchart.png" border="0" id="chart"/></a>
<A href="<%=info.getReqUrl()%>/report/commonpieChart.jsp?key=<%=replaceplus%>&col=ALL&clr=" target="SC"  onclick="loadASSFNLPop('chart')" title="Click Here To See Pie Chart">
<img src="../images/piechart.png" border="0" id="chart"/></a><%}%>
  </th>
  <%  
  colnum=0;
