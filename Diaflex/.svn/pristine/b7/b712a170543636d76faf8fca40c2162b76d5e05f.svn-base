...
<bean:write property="reportNme" name="groupWiseForm" />
  ...
  <tr><td valign="top" class="hedPg">Create Excel <img src="../images/ico_file_excel.png" title="Click here to Generate Excel" onclick="goToCreateXl('group.do?method=createGridXL&excelNm=StatusLab&Report=STT')" border="0"/>&nbsp; 
...
pageList= ((ArrayList)pageDtl.get("CHK") == null)?new ArrayList():(ArrayList)pageDtl.get("CHK");  
  ...
  %>
  <td align="right" style="padding:0px"><span><a  title="Shape Size report" href="group.do?method=loadSHSZ&group=<%=group%>&lab=<%=lab%>&stt=<%=stt%>&loc=<%=locS%>&valueDisplay=<%=valueDisplay%>&mlot=<%=mlot%>" ><%=Qty%></a></span></td>
  <td align="right" style="padding:0px"><span id="CTS_<%=j%>_<%=k%>" style="display:none;"><a title="Packet Details" target="_blank"  href="group.do?method=pktDtl&group=<%=group%>&lab=<%=lab%>&stt=<%=stt%>&loc=<%=locS%>&valueDisplay=<%=valueDisplay%>&mlot=<%=mlot%>" ><%=Cts%></a></span></td>
  ...
  %>
  <td align="right" style="padding:0px"><span><a  title="Shape Size report" href="group.do?method=loadSHSZ&group=<%=group%>&lab=<%=labGroup%>&stt=<%=stt%>&loc=<%=locS%>&valueDisplay=<%=valueDisplay%>&mlot=<%=mlot%>" ><%=Qty%></a></span></td>
   <td align="right" style="padding:0px"><span id="TOTALCTS_<%=j%>" style="display:none;"><a title="Packet Details" target="_blank"  href="group.do?method=pktDtl&group=<%=group%>&lab=<%=labGroup%>&stt=<%=stt%>&loc=<%=locS%>&valueDisplay=<%=valueDisplay%>&mlot=<%=mlot%>" ><%=Cts%></a></span></td>
  ...
  %>
   <td align="right" style="padding:0px"><span><a  title="Shape Size report" href="group.do?method=loadSHSZ&group=<%=group%>&lab=<%=lab%>&stt=ALL&loc=<%=locS%>&valueDisplay=<%=valueDisplay%>&mlot=<%=mlot%>" ><%=Qty%></a></span></td>
   <td align="right" style="padding:0px"><span id="TTLCTS_<%=i%>" style="display:none;"><a title="Packet Details" target="_blank"  href="group.do?method=pktDtl&group=<%=group%>&lab=<%=lab%>&stt=ALL&loc=<%=locS%>&valueDisplay=<%=valueDisplay%>&mlot=<%=mlot%>" ><%=Cts%></a></span></td>
  ...
  %>
  <td align="right" style="padding:0px"><span><a  title="Shape Size report" href="group.do?method=loadSHSZ&group=<%=group%>&lab=<%=labGroup%>&stt=ALL&loc=<%=locS%>&valueDisplay=<%=valueDisplay%>&mlot=<%=mlot%>" ><%=Qty%></a></span></td>
   <td align="right" style="padding:0px"><span id="GTTLCTS" style="display:none;"><a title="Packet Details" target="_blank"  href="group.do?method=pktDtl&group=<%=group%>&lab=<%=labGroup%>&stt=ALL&loc=<%=locS%>&valueDisplay=<%=valueDisplay%>&mlot=<%=mlot%>" ><%=Cts%></a></span></td>
