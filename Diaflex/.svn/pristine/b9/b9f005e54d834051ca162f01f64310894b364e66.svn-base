...
<html>
  <head>
    ...
    <title>Lot Property Details</title>
...
<table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0" class="mainbg">
  ...
  <%
   ArrayList params = new ArrayList();
    ...
    String formAction = "/masters/lotprp.do?method=save";
 %>
 <tr>
    ...
    for(int dsp=0; dsp < dspOrder.size(); dsp++) {
      ...
      <%
        ...
        <%}else {
            ...
            String link = info.getReqUrl() + "/masters/lotprp.do?method=delete&idn="+ fldId ;
