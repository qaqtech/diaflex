...
public class ProcessAlwAction extends DispatchAction {
    private final String formName   = "prcprpalwFrm";


    public ProcessAlwAction() {
        super();
    }
    ...
    public ActionForward save(ActionMapping am, ActionForm af, HttpServletRequest req, HttpServletResponse res)
        ...
        if(!rtnPg.equals("sucess")){
            ...
            util.updAccessLog(req,res,"Prc Prp Alw form", "save start");
        ...
        if (udf.getAddnew() != null) {
            ...
            for (int i = 1; i <= lmt; i++) {
                ...
                String insIntoQ = " insert into prc_prp_alw (prc_prp_idn , prc_idn ";
                String insValQ  = "values(prc_prp_alw_idn.nextval , ? ";
        ...
        if (udf.getModify() != null) {
            ...
            String srchFields = helper.getSrchFields(daos, "prc_prp_idn", false);
            String srchQ      = " and prc_idn = ? ";
            
            String getMenu    = "select " + srchFields + " from prc_prp_alw where 1 = 1 " + srchQ + " order by 1";
            ArrayList params     = new ArrayList();
            params.add(prcIdn);
            ...
            while (rs.next()) {
                ...
                String updQ  = " update prc_prp_alw set prc_prp_idn = prc_prp_idn ";
                String condQ = " where prc_prp_idn = ? ";
                boolean isValid = false;
        ...
        req.setAttribute("errors", errorList);
            util.updAccessLog(req,res,"Prc Prp Alw form", "save end");
    ...
    public ActionForward load(ActionMapping am, ActionForm af, HttpServletRequest req, HttpServletResponse res)
        ...
        if(!rtnPg.equals("sucess")){
            ...
            util.updAccessLog(req,res,"Prc Prp Alw form", "load start");
            HashMap  formFields = info.getFormFields(formName);
        ...
        rs.close();
        String    srchFields = helper.getSrchFields(daos, "prc_prp_idn");
        String    srchQ      = " and prc_idn = ? ";
        ...
        udf.setValue("prcIdn", prcIdn);
            util.updAccessLog(req,res,"Prc Prp Alw form", "load end");
    ...
    public ActionForward delete(ActionMapping am, ActionForm af, HttpServletRequest req, HttpServletResponse res)
        ...
        if(!rtnPg.equals("sucess")){
            ...
            util.updAccessLog(req,res,"Prc Prp Alw form", "delete start");
        ProcessMasterFrm udf = (ProcessMasterFrm) af;
        String prc_prp_idn = req.getParameter("Idn");
        String deletePrcAlw = "delete from prc_prp_alw where prc_prp_idn = ? ";
        ArrayList ary = new ArrayList();
        ary.add(prc_prp_idn);
        int ct = db.execUpd("deletPrcPrp", deletePrcAlw, ary);
            util.updAccessLog(req,res,"Prc Prp Alw form", "delete end");
        return load(am, af, req, res);
        }
    }
    ...
    public String init(HttpServletRequest req , HttpServletResponse res,HttpSession session,DBUtil util) {
            ...
            System.out.print("New Session Id :="+session.getId());
                ...
                util.updAccessLog(req,res,"Prc Prp Alw form", "Unauthorized Access");
                else
                util.updAccessLog(req,res,"Prc Prp Alw form", "init");
            }
            }
            return rtnPg;
         }
