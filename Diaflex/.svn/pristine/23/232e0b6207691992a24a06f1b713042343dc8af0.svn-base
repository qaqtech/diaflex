...
public class WebRoleAction  extends DispatchAction {
   
    public WebRoleAction() {
        super();
    }
    ...
    public ActionForward load(ActionMapping am, ActionForm af, HttpServletRequest req, HttpServletResponse res)
      ...
      if(!rtnPg.equals("sucess")){
          ...
          util.updAccessLog(req,res,"WebRoleAction", "load");
          HashMap  formFields = info.getFormFields("webrolemaster");

          if ((formFields == null) || (formFields.size() == 0)) {
              formFields = util.getFormFields("webrolemaster");
          }
       ...
       WebRoleForm  udf = (WebRoleForm) af;
        ...
        String srchFields = helper.getSrchFields(daos,"ROLE_IDN");
        String srchQ      = " ";
        ...
        req.setAttribute("webrolemaster", list);
    ...
    public ActionForward save(ActionMapping am, ActionForm af, HttpServletRequest req, HttpServletResponse res)
      ...
      if(!rtnPg.equals("sucess")){
          ...
          util.updAccessLog(req,res,"WebRoleAction", "save");
          HashMap  formFields = info.getFormFields("webrolemaster");
       ...
       WebRoleForm  udf = (WebRoleForm) af;
        ...
        if (udf.getAddnew() != null) {
            ...
            for (int i = 1; i <= lmt; i++) {
                ...
                String insIntoQ = " insert into mrole ( role_idn ";
                String insValQ  = "values(seq_mrole.nextval ";
        ...
        if (udf.getModify() != null) {
            ...
            String    getMenu = "select " + helper.getSrchFields(daos, "ROLE_IDN", false) + " from mrole  ";
            ArrayList    params  = new ArrayList();
            ...
            while (rs.next()) {
                ...
                String updQ  = " update mrole set ROLE_IDN = ROLE_IDN ";
                String condQ = " where ROLE_IDN = ? ";
                boolean isValid = false;
  ...
  public String init(HttpServletRequest req , HttpServletResponse res,HttpSession session,DBUtil util) {
          ...
          System.out.print("New Session Id :="+session.getId());
              ...
              util.updAccessLog(req,res,"Web Role Action", "Unauthorized Access");
              else
          util.updAccessLog(req,res,"Web Role Action", "init");
          }
          }
          return rtnPg;
       }
