...
public class CountryAction extends DispatchAction {
    private final String formName   = "countryfrm";
    ...
    public ActionForward save(ActionMapping am, ActionForm af, HttpServletRequest req, HttpServletResponse res)
        ...
        if(!rtnPg.equals("sucess")){
            ...
            util.updAccessLog(req,res,"Country form", "save start");
        ...
        if (udf.getAddnew() != null) {
            ...
            for (int i = 1; i <= lmt; i++) {
                ...
                String insIntoQ = " insert into mcountry ( country_idn ";
                String insValQ  = "values(COUNTRY_SEQ.nextval ";
        ...
        if (udf.getModify() != null) {
            ...
            String    getMenu = "select " + helper.getSrchFields(daos, "country_idn", false) + " from mcountry  ";
            ArrayList    params  = new ArrayList();
            ResultSet rs      = db.execSql("getUIFormFields for update", getMenu, params);

            while (rs.next()) {
                int    lIdn  = rs.getInt(1);
                String updQ  = " update mcountry set country_idn = country_idn ";
                String condQ = " where country_idn = ? ";
                boolean isValid = false;
        ...
        req.setAttribute("errors", errorList);
            util.updAccessLog(req,res,"Country form", "save end");
    ...
    public ActionForward load(ActionMapping am, ActionForm af, HttpServletRequest req, HttpServletResponse res)
        ...
        if(!rtnPg.equals("sucess")){
            ...
            util.updAccessLog(req,res,"Country form", "load start");
            HashMap  formFields = info.getFormFields(formName);
        ...
        String srchFields = helper.getSrchFields(daos, "country_idn");
        String srchQ      = " ";
        ...
        util.updAccessLog(req,res,"Country form", "load end");
    ...
    public String init(HttpServletRequest req , HttpServletResponse res,HttpSession session,DBUtil util) {
            ...
            System.out.print("New Session Id :="+session.getId());
                ...
                util.updAccessLog(req,res,"Country form", "Unauthorized Access");
                else
                util.updAccessLog(req,res,"Country form", "init");
            }
            }
            return rtnPg;
         }
