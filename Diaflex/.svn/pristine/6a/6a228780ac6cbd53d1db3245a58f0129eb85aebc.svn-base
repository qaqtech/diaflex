...
public class SubSizeDefAction extends DispatchAction {
    private final String formName   = "gszform";

        public SubSizeDefAction() {
        super();
    }
    ...
    public ActionForward save(ActionMapping am, ActionForm af, HttpServletRequest req, HttpServletResponse res)
        ...
        if(!rtnPg.equals("sucess")){
            ...
            util.updAccessLog(req,res,"Sub Size Defination", "save start");
        ...
        SubSizeDefForm udf = (SubSizeDefForm) af;
        ...
        if (udf.getAddnew() != null) {
            ...
            for (int i = 1; i <= lmt; i++) {
                ...
                String insIntoQ = " insert into gsz ( idn ";
                String insValQ  = "values(SEQ_GSZ.nextval ";
        ...
        if (udf.getModify() != null) {
            ...
            String    getMenu = "select " + helper.getSrchFields(daos, "idn", false) + " from gsz  ";
            ArrayList    params  = new ArrayList();
            ResultSet rs      = db.execSql("getUIFormFields for update", getMenu, params);

            while (rs.next()) {
                int    lIdn  = rs.getInt(1);
                String updQ  = " update gsz set idn = idn ";
        ...
        if (udf.getDelete() != null) {
            ...
            if(!lIdnlst.equals("")){
                ...
                int ct = db.execUpd(" del msg", "delete from gsz where idn in("+lIdnlst+")", new ArrayList());
            }
        }
        req.setAttribute("errors", errorList);
            util.updAccessLog(req,res,"Sub Size Defination", "save end");
    ...
    public ActionForward load(ActionMapping am, ActionForm af, HttpServletRequest req, HttpServletResponse res)
        ...
        if(!rtnPg.equals("sucess")){
            ...
            util.updAccessLog(req,res,"Sub Size Defination", "load start");
            HashMap  formFields = info.getFormFields(formName);
        ...
        // udf = (SubSizeDefForm)helper.getForm(uiForms, "", srchFields, srchQ, new ArrayList(), daos, "VIEW") ;
        req.setAttribute(formName, list);

        // udf.setList(list);
        // info.setNmeSrchList(list);
     
        util.updAccessLog(req,res,"Sub Size Defination", "load end");
  ...
  public ActionForward delete(ActionMapping am, ActionForm af, HttpServletRequest req, HttpServletResponse res)
      ...
      if(!rtnPg.equals("sucess")){
          ...
          util.updAccessLog(req,res,"Sub Size Defination", "delete start");
      SubSizeDefForm udf = (SubSizeDefForm) af;

      int    idn  = udf.getId();
      String delQ = " delete from gsz where idn = ? ";
      ArrayList ary  = new ArrayList();

      ary.add(String.valueOf(idn));

      int ct = db.execUpd(" del trms", delQ, ary);
          util.updAccessLog(req,res,"Sub Size Defination", "delete end");
      return load(am, af, req, res);
      }
  }
    ...
    public String init(HttpServletRequest req , HttpServletResponse res,HttpSession session,DBUtil util) {
            ...
            System.out.print("New Session Id :="+session.getId());
                ...
                util.updAccessLog(req,res,"Sub Size Defination", "Unauthorized Access");
                else
                util.updAccessLog(req,res,"Sub Size Defination", "init");
            }
            }
            return rtnPg;
         }
