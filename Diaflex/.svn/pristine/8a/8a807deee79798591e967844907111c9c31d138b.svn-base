...
public class InwardAction extends DispatchAction {
    private final String formName   = "inwardForm";
    ...
    public ActionForward save(ActionMapping am, ActionForm af, HttpServletRequest req, HttpServletResponse res)
        ...
        if(!rtnPg.equals("sucess")){
            ...
            util.updAccessLog(req,res,"IFRS_DLY_INWARD form", "save start");
        ...
        if (udf.getAddnew() != null) {
            ...
            for (int i = 1; i <= lmt; i++) {
                ...
                String insIntoQ = " insert into IFRS_DLY_INWARD ( idn ";
                String insValQ  = "values(IFRS_DLY_INWARD_SEQ.nextval ";
        ...
        if (udf.getModify() != null) {
            ...
            String    getMenu = "select " + helper.getSrchFields(daos, "idn", false) + " from IFRS_DLY_INWARD  ";
            ArrayList    params  = new ArrayList();
            ResultSet rs      = db.execSql("getUIFormFields for update", getMenu, params);

            while (rs.next()) {
                int    lIdn  = rs.getInt(1);
                String updQ  = " update IFRS_DLY_INWARD set idn = idn ";
        ...
        if (udf.getDelete() != null) {
            ...
            if(!lIdnlst.equals("")){
                ...
                int ct = db.execUpd(" del msg", "update IFRS_DLY_INWARD set stt='IA' where idn in("+lIdnlst+")", new ArrayList());
            }
        }
        req.setAttribute("errors", errorList);
            util.updAccessLog(req,res,"IFRS_DLY_INWARD form", "save end");
    ...
    public ActionForward load(ActionMapping am, ActionForm af, HttpServletRequest req, HttpServletResponse res)
        ...
        if(!rtnPg.equals("sucess")){
            ...
            util.updAccessLog(req,res,"IFRS_DLY_INWARD form", "load start");
            HashMap  formFields = info.getFormFields(formName);
        ...
        String days = (String)dbinfo.get("DEFAULTDAYSIFRSINWARD");
        ArrayList parmas     = new ArrayList();
        String srchFields = helper.getSrchFields(daos, "idn");
        String srchQ      = " and trunc(IFRS_DLY_INWARD.dte)>=trunc(sysdate)-"+days+" ";
        ...
        // udf = (InwardForm)helper.getForm(uiForms, "", srchFields, srchQ, new ArrayList(), daos, "VIEW") ;
        req.setAttribute(formName, list);

        // udf.setList(list);
        // info.setNmeSrchList(list);
        util.updAccessLog(req,res,"IFRS_DLY_INWARD form", "load end");
  ...
  public ActionForward delete(ActionMapping am, ActionForm af, HttpServletRequest req, HttpServletResponse res)
      ...
      if(!rtnPg.equals("sucess")){
          ...
          util.updAccessLog(req,res,"IFRS_DLY_INWARD form", "delete start");
      InwardForm udf = (InwardForm) af;

      String    idn  = util.nvl(req.getParameter("idn"));
      String delQ = " update IFRS_DLY_INWARD set stt='IA' where idn = ? ";
      ArrayList ary  = new ArrayList();

      ary.add(idn);

      int ct = db.execUpd(" del msg", delQ, ary);
          util.updAccessLog(req,res,"IFRS_DLY_INWARD form", "delete end");
      return load(am, af, req, res);
      }
  }
    ...
    public String init(HttpServletRequest req , HttpServletResponse res,HttpSession session,DBUtil util) {
            ...
            System.out.print("New Session Id :="+session.getId());
                ...
                util.updAccessLog(req,res,"IFRS_DLY_INWARD form", "Unauthorized Access");
                else
                util.updAccessLog(req,res,"IFRS_DLY_INWARD form", "init");
            }
            }
            return rtnPg;
         }
