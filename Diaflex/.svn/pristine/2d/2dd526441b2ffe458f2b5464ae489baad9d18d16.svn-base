...
<html>
  <head>
    ...
    <title>Process To Process </title>
  ...
  <%
   ArrayList params = new ArrayList();
    ...
    String pgTtl = uiForms.getFORM_TTL();
     pgTtl = pgTtl.replaceAll("~proces", util.nvl((String)info.getValue("PRC"),""));
    dbutil.SOP(" View "+ formName + " : fields = " + daos.size());
    int addRec = Integer.parseInt(util.nvl(uiForms.getREC(),"10"));
    String formAction = "/masters/prcToPrcAction.do?method=save";
 %>
 <tr>
