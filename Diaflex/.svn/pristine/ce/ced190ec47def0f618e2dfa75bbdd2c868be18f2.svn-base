...
public class MixSizeDefination extends DispatchAction {
    private final String formName   = "mixszform";

    public MixSizeDefination() {
        super();
    }
    ...
    public ActionForward save(ActionMapping am, ActionForm af, HttpServletRequest req, HttpServletResponse res)
        ...
        SizeDefForm udf = (SizeDefForm) af;
        ...
        if (udf.getAddnew() != null) {
            ...
            for (int i = 1; i <= lmt; i++) {
                ...
                String insIntoQ = " insert into mix_sz ( idn ";
                String insValQ  = "values(MIX_SZ_SEQ.nextval ";
        ...
        if (udf.getModify() != null) {
            ...
            String    getMenu = "select " + helper.getSrchFields(daos, "idn", false) + " from mix_sz  ";
            ArrayList    params  = new ArrayList();
            ResultSet rs      = db.execSql("getUIFormFields for update", getMenu, params);

            while (rs.next()) {
                int    lIdn  = rs.getInt(1);
                String updQ  = " update mix_sz set idn = idn ";
        ...
        if (udf.getDelete() != null) {
            String lIdnlst="";
            String    getMenu = "select " + helper.getSrchFields(daos, "idn", false) + " from msz  ";
            ArrayList    params  = new ArrayList();
            ResultSet rs      = db.execSql("getUIFormFields for update", getMenu, params);
            ...
            if(!lIdnlst.equals("")){
                ...
                int ct = db.execUpd(" del msg", "delete from msz where idn in("+lIdnlst+")", new ArrayList());
            }
        }
    ...
    public ActionForward load(ActionMapping am, ActionForm af, HttpServletRequest req, HttpServletResponse res)
        ...
        // udf = (SizeDefForm)helper.getForm(uiForms, "", srchFields, srchQ, new ArrayList(), daos, "VIEW") ;
    ...
    public ActionForward delete(ActionMapping am, ActionForm af, HttpServletRequest req, HttpServletResponse res)
      ...
      int    idn  = udf.getId();
      String delQ = " delete from mix_sz where idn = ? ";
