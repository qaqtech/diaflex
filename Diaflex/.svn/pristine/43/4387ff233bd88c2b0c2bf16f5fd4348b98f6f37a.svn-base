...
public class ClientInfoAction extends DispatchAction {
    private final String formName   = "dbmsform";
    ...
    public ActionForward save(ActionMapping am, ActionForm af, HttpServletRequest req, HttpServletResponse res)
        ...
        if(!rtnPg.equals("sucess")){
            ...
            util.updAccessLog(req,res,"DBMS SYS INFO form", "save start");
        ...
        ClientInfoForm udf = (ClientInfoForm) af;
        ...
        if (udf.getAddnew() != null) {
            ...
            for (int i = 1; i <= lmt; i++) {
                ...
                String insIntoQ = " insert into dbms_sys_info ( id,flg ";
                String insValQ  = "values(dbms_sys_info_seq.nextval,? ";
                params.add("C");
        ...
        if (udf.getModify() != null) {
            ...
            String    getMenu = "select " + helper.getSrchFields(daos, "id", false) + " from dbms_sys_info  ";
            ArrayList    params  = new ArrayList();
            ResultSet rs      = db.execSql("getUIFormFields for update", getMenu, params);

            while (rs.next()) {
                int    lIdn  = rs.getInt(1);
                String updQ  = " update dbms_sys_info set id = id ";
                String condQ = " where id = ? ";
                boolean isValid = false;
        ...
        if (udf.getDelete() != null) {
            ...
            if(!lIdnlst.equals("")){
                ...
                int ct = db.execUpd(" del msg", "delete from dbms_sys_info where id in("+lIdnlst+")", new ArrayList());
            }
        }
        req.setAttribute("errors", errorList);
            util.updAccessLog(req,res,"DBMS SYS INFO form", "save end");
    ...
    public ActionForward load(ActionMapping am, ActionForm af, HttpServletRequest req, HttpServletResponse res)
        ...
        if(!rtnPg.equals("sucess")){
            ...
            util.updAccessLog(req,res,"DBMS SYS INFO form", "load start");
            HashMap  formFields = info.getFormFields(formName);
        ...
        String srchFields = helper.getSrchFields(daos, "id");
        String srchQ      = " ";
        ...
        // udf = (ClientInfoForm)helper.getForm(uiForms, "", srchFields, srchQ, new ArrayList(), daos, "VIEW") ;
        req.setAttribute(formName, list);

        // udf.setList(list);
        // info.setNmeSrchList(list);
     
        util.updAccessLog(req,res,"DBMS SYS INFO form", "load end");
  ...
  public ActionForward delete(ActionMapping am, ActionForm af, HttpServletRequest req, HttpServletResponse res)
      ...
      if(!rtnPg.equals("sucess")){
          ...
          util.updAccessLog(req,res,"DBMS SYS INFO form", "delete start");
      ClientInfoForm udf = (ClientInfoForm) af;

      int    idn  = udf.getId();
      String delQ = " delete from dbms_sys_info where id = ? ";
      ArrayList ary  = new ArrayList();

      ary.add(String.valueOf(idn));

      int ct = db.execUpd(" del trms", delQ, ary);
          util.updAccessLog(req,res,"DBMS SYS INFO form", "delete end");
      return load(am, af, req, res);
      }
  }
    ...
    public String init(HttpServletRequest req , HttpServletResponse res,HttpSession session,DBUtil util) {
            ...
            System.out.print("New Session Id :="+session.getId());
                ...
                util.updAccessLog(req,res,"DBMS SYS INFO form", "Unauthorized Access");
                else
                util.updAccessLog(req,res,"DBMS SYS INFO form", "init");
            }
            }
            return rtnPg;
         }
