...
public class DeptEmpAction extends DispatchAction {
    private final String formName   = "deptToEmpForm";


    public DeptEmpAction() {
        super();
    }
    ...
    public String init(HttpServletRequest req , HttpServletResponse res,HttpSession session,DBUtil util) {
            ...
            System.out.print("New Session Id :="+session.getId());
                ...
                util.updAccessLog(req,res,"Dept To EMP form", "Unauthorized Access");
                else
                util.updAccessLog(req,res,"Dept To EMP form", "init");
            }
            }
            return rtnPg;
         }
    public ActionForward load(ActionMapping am, ActionForm af, HttpServletRequest req, HttpServletResponse res)
        ...
        if(!rtnPg.equals("sucess")){
            ...
            util.updAccessLog(req,res,"Dept To EMP form", "load start");
        ...
        DeptEmpForm udf = (DeptEmpForm) af;
        ...
        if (deptIdn == null) {
            deptIdn = (String)udf.getValue("deptIdn");
        }
        if (deptIdn == null) {
            deptIdn = (String)info.getValue("deptIdn");
        }
        ...
        info.setValue("deptIdn", deptIdn);
        String    srchFields = helper.getSrchFields(daos, "demp_idn");
        String    srchQ      = " and dept_idn = ?  ";
        ...
        udf.setValue("deptIdn", deptIdn);
            util.updAccessLog(req,res,"Dept To EMP form", "load end");
    ...
    public ActionForward save(ActionMapping am, ActionForm af, HttpServletRequest req, HttpServletResponse res)
        ...
        if(!rtnPg.equals("sucess")){
            ...
            util.updAccessLog(req,res,"Dept To EMP form", "save start");
            HashMap  formFields = info.getFormFields(formName);
        ...
        String deptIdn = (String) udf.getValue("deptIdn");
        ...
        if (udf.getAddnew() != null) {
            ...
            for (int i = 1; i <= lmt; i++) {
                ...
                ArrayList params   = new ArrayList();
                String insIntoQ = " insert into dept_emp_valid ( demp_idn, dept_idn  ";
                String insValQ  = "values(dept_emp_seq.nextval ,? ";
        ...
        if (udf.getModify() != null) {
            ...
            String srchFields = helper.getSrchFields(daos, "demp_idn", false);
            String srchQ      = " and dept_idn = ? ";

            // ArrayList list = helper.getSrchList(uiForms, "", srchFields, srchQ, params, daos, "VIEW");
            String getMenu    = "select " + srchFields + " from dept_emp_valid where 1 = 1 " + srchQ + " order by "+uiForms.getORDER_BY();
            ArrayList params     = new ArrayList();
            ...
            while (rs.next()) {
                ...
                String updQ  = " update dept_emp_valid set demp_idn = demp_idn ";
                String condQ = " where demp_idn = ?";
                boolean isValid = false;
        ...
        req.setAttribute("errors", errorList);
            util.updAccessLog(req,res,"Dept To EMP form", "save end");
    ...
    public ActionForward delete(ActionMapping am, ActionForm af, HttpServletRequest req, HttpServletResponse res)
        ...
        if(!rtnPg.equals("sucess")){
            ...
            util.updAccessLog(req,res,"Dept To EMP form", "delete start");
        DeptEmpForm udf = (DeptEmpForm) af;
        String Idn = req.getParameter("Idn");
        String deleteCity = "update dept_emp_valid set dte_to=sysdate where idn= ?";
