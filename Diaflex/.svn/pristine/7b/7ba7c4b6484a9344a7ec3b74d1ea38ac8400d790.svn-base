...
<table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0" class="mainbg">
  ...
  <%  
   ...
   <table><tr><td>
   <html:form action="mix/mixEditRtnAction.do?method=fecth" method="post" onsubmit="return validate_Assortreturn()">
   ...
   <tr>
   <td>Issue Id:</td><td> <html:text property="value(issueId)" styleId="issueId"  name="assortReturnForm"  /></td>
   </tr>
   <tr>
   ...
   if(stockListMap!=null && stockListMap.size()>0){
    ArrayList vwPrpLst = (ArrayList)session.getAttribute("MIX_VIEW");
      ...
      String openPopUp = "openPopUp('mixEditRtnAction.do?method=Openpop&prcID="+prcId+"' ,'SC','multiprp')";
       if(options == null)
 ...
 <tr><td>
   ...
   <tr><td>Total :&nbsp;&nbsp;</td><td><span id="ttlqty"><%=totals.get("qty")%></span> &nbsp;&nbsp;</td><td>cts&nbsp;&nbsp;</td><td><span id="ttlcts"> <%=totals.get("cts")%></span> &nbsp;&nbsp;</td><td>Selected:&nbsp;&nbsp;</td><td> Total :&nbsp;&nbsp;</td> <td><span id="qtyTtl">0&nbsp;&nbsp;</span></td><td>Cts&nbsp;&nbsp;</td><td><span id="ctsTtl">0</span> </td> </tr>
    ...
    <html:form action="mix/mixEditRtnAction.do?method=Return" method="post" onsubmit="return validate_issue('CHK_' , 'count')" >
...
<%}}%> 
<%if(options.size()>0){ %>
<th><div class="float">Status</div>

<div class="float"><input type="radio" name="STT" id="NONE" onclick="ALLRedio('NONE','NONE_')" />&nbsp;NONE</div>
...
String rfId = "NONE_"+stkIdn;
%>
<td><html:radio property="<%=rfldNme%>" styleId="<%=rfId%>" value="NONE"/>&nbsp;NONE</td>
<%
for(int j=0; j < options.size(); j++) {%>
