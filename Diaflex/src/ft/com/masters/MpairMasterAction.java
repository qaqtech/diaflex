...
public class MpairMasterAction extends DispatchAction {
    private final String formName   = "matchpairform";


        public MpairMasterAction() {
        super();
    }
    ...
    public ActionForward save(ActionMapping am, ActionForm af, HttpServletRequest req, HttpServletResponse res)
        ...
        if(!rtnPg.equals("sucess")){
            ...
            util.updAccessLog(req,res,"Matchpair form", "save start");
        ...
        MpairMasterForm udf = (MpairMasterForm) af;
        ...
        if (udf.getAddnew() != null) {
            ...
            for (int i = 1; i <= lmt; i++) {
                ...
                String insIntoQ = " insert into mrule ( rule_idn,mdl ";
                String insValQ  = "values(mrule_seq.nextval,? ";
                params.add("MATCHPAIR");
        ...
        req.setAttribute("errors", errorList);
            util.updAccessLog(req,res,"Matchpair form", "save end");
    ...
    public ActionForward load(ActionMapping am, ActionForm af, HttpServletRequest req, HttpServletResponse res)
        ...
        if(!rtnPg.equals("sucess")){
            ...
            util.updAccessLog(req,res,"Matchpair form", "load start");
            HashMap  formFields = info.getFormFields(formName);
        ...
        // udf = (MpairMasterForm)helper.getForm(uiForms, "", srchFields, srchQ, new ArrayList(), daos, "VIEW") ;
        req.setAttribute(formName, list);

        // udf.setList(list);
        // info.setNmeSrchList(list);
       
        util.updAccessLog(req,res,"Matchpair form", "load end");
    ...
    public String init(HttpServletRequest req , HttpServletResponse res,HttpSession session,DBUtil util) {
            ...
            System.out.print("New Session Id :="+session.getId());
                ...
                util.updAccessLog(req,res,"Matchpair form", "Unauthorized Access");
                else
                util.updAccessLog(req,res,"Matchpair form", "init");
            }
            }
            return rtnPg;
         }
