...
public class PricingSizeDefAction extends DispatchAction {

    private final String formName   = "pszform";

        public PricingSizeDefAction() {
        super();
    }
    ...
    public ActionForward save(ActionMapping am, ActionForm af, HttpServletRequest req, HttpServletResponse res)
        ...
        PricingSizeDefForm udf = (PricingSizeDefForm) af;
        ...
        if (udf.getAddnew() != null) {
            ...
            for (int i = 1; i <= lmt; i++) {
                ...
                String insIntoQ = " insert into psz ( idn ";
                String insValQ  = "values(SEQ_PSZ.nextval ";
        ...
        if (udf.getModify() != null) {
            ...
            String    getMenu = "select " + helper.getSrchFields(daos, "idn", false) + " from psz  ";
            ArrayList    params  = new ArrayList();
            ResultSet rs      = db.execSql("getUIFormFields for update", getMenu, params);

            while (rs.next()) {
                int    lIdn  = rs.getInt(1);
                String updQ  = " update psz set idn = idn ";
        ...
        if (udf.getDelete() != null) {
            ...
            if(!lIdnlst.equals("")){
                ...
                int ct = db.execUpd(" del msg", "delete from psz where idn in("+lIdnlst+")", new ArrayList());
            }
        }
    ...
    public ActionForward load(ActionMapping am, ActionForm af, HttpServletRequest req, HttpServletResponse res)
        ...
        // udf = (PricingSizeDefForm)helper.getForm(uiForms, "", srchFields, srchQ, new ArrayList(), daos, "VIEW") ;
  ...
  public ActionForward delete(ActionMapping am, ActionForm af, HttpServletRequest req, HttpServletResponse res)
      ...
      int    idn  = udf.getId();
      String delQ = " delete from psz where idn = ? ";
