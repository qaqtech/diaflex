...
public class RapUsrInfoAction extends DispatchAction {
    private final String formName   = "rapusrinfoform";

        public RapUsrInfoAction() {
        super();
    }
    ...
    public ActionForward save(ActionMapping am, ActionForm af, HttpServletRequest req, HttpServletResponse res)
        ...
        if(!rtnPg.equals("sucess")){
            ...
            util.updAccessLog(req,res,"RAP USER INFO form", "save start");
        ...
        RapUsrInfoForm udf = (RapUsrInfoForm) af;
        ...
        if (udf.getAddnew() != null) {
            ...
            for (int i = 1; i <= lmt; i++) {
                ...
                String insIntoQ = " insert into RAP_USER_INFO ( idn ";
                String insValQ  = "values(RAP_USER_INFO_SEQ.nextval ";
        ...
        if (udf.getModify() != null) {
            ...
            String    getMenu = "select " + helper.getSrchFields(daos, "idn", false) + " from RAP_USER_INFO  ";
            ArrayList    params  = new ArrayList();
            ResultSet rs      = db.execSql("getUIFormFields for update", getMenu, params);

            while (rs.next()) {
                int    lIdn  = rs.getInt(1);
                String updQ  = " update RAP_USER_INFO set idn = idn ";
        ...
        if (udf.getDelete() != null) {
            ...
            if(!lIdnlst.equals("")){
                ...
                int ct = db.execUpd(" del msg", "delete from RAP_USER_INFO where idn in("+lIdnlst+")", new ArrayList());
            }
        }
        req.setAttribute("errors", errorList);
            util.updAccessLog(req,res,"RAP USER INFO form", "save end");
    ...
    public ActionForward load(ActionMapping am, ActionForm af, HttpServletRequest req, HttpServletResponse res)
        ...
        if(!rtnPg.equals("sucess")){
            ...
            util.updAccessLog(req,res,"RAP USER INFO form", "load start");
            HashMap  formFields = info.getFormFields(formName);
        ...
        // udf = (RapUsrInfoForm)helper.getForm(uiForms, "", srchFields, srchQ, new ArrayList(), daos, "VIEW") ;
        req.setAttribute(formName, list);

        // udf.setList(list);
        // info.setNmeSrchList(list);
     
        util.updAccessLog(req,res,"RAP USER INFO form", "load end");
  ...
  public ActionForward delete(ActionMapping am, ActionForm af, HttpServletRequest req, HttpServletResponse res)
      ...
      if(!rtnPg.equals("sucess")){
          ...
          util.updAccessLog(req,res,"RAP USER INFO form", "delete start");
      RapUsrInfoForm udf = (RapUsrInfoForm) af;

      String    idn  = util.nvl(req.getParameter("idn"));
      String delQ = " delete from RAP_USER_INFO where idn = ? ";
      ArrayList ary  = new ArrayList();

      ary.add(idn);

      int ct = db.execUpd(" del trms", delQ, ary);
          util.updAccessLog(req,res,"RAP USER INFO form", "delete end");
      return load(am, af, req, res);
      }
  }
    ...
    public String init(HttpServletRequest req , HttpServletResponse res,HttpSession session,DBUtil util) {
            ...
            System.out.print("New Session Id :="+session.getId());
                ...
                util.updAccessLog(req,res,"RAP USER INFO form", "Unauthorized Access");
                else
                util.updAccessLog(req,res,"RAP USER INFO form", "init");
            }
            }
            return rtnPg;
         }
