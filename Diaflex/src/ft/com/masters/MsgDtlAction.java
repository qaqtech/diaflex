...
public class MsgDtlAction extends DispatchAction {
    private final String formName   = "msgdtlform";
    ...
    public ActionForward save(ActionMapping am, ActionForm af, HttpServletRequest req, HttpServletResponse res)
        ...
        if(!rtnPg.equals("sucess")){
            ...
            util.updAccessLog(req,res,"Msg form", "save start");
        ...
        if (udf.getAddnew() != null) {
            ...
            for (int i = 1; i <= lmt; i++) {
                ...
                String insIntoQ = " insert into df_msg_log ( msg_id ";
                String insValQ  = "values(df_msg_log_seq.nextval ";
        ...
        if (udf.getModify() != null) {
            ...
            String    getMenu = "select " + helper.getSrchFields(daos, "msg_id", false) + " from df_msg_log  ";
            ArrayList    params  = new ArrayList();
            ResultSet rs      = db.execSql("getUIFormFields for update", getMenu, params);

            while (rs.next()) {
                int    lIdn  = rs.getInt(1);
                String updQ  = " update df_msg_log set msg_id = msg_id ";
                String condQ = " where msg_id = ? ";
                boolean isValid = false;
        ...
        if (udf.getDelete() != null) {
            ...
            if(!lIdnlst.equals("")){
                ...
                int ct = db.execUpd(" del msg", "update df_msg_log set stt='IA',flg='IA' where msg_id in("+lIdnlst+")", new ArrayList());
            }
        }
        req.setAttribute("errors", errorList);
            util.updAccessLog(req,res,"Msg form", "save end");
    ...
    public ActionForward load(ActionMapping am, ActionForm af, HttpServletRequest req, HttpServletResponse res)
        ...
        if(!rtnPg.equals("sucess")){
            ...
            util.updAccessLog(req,res,"Msg form", "load start");
            HashMap  formFields = info.getFormFields(formName);
        ...
        String srchFields = helper.getSrchFields(daos, "msg_id");
        String srchQ      = " ";
        ...
        // udf = (MsgDtlForm)helper.getForm(uiForms, "", srchFields, srchQ, new ArrayList(), daos, "VIEW") ;
        req.setAttribute(formName, list);

        // udf.setList(list);
        // info.setNmeSrchList(list);
     
        util.updAccessLog(req,res,"Msg form", "load end");
  ...
  public ActionForward delete(ActionMapping am, ActionForm af, HttpServletRequest req, HttpServletResponse res)
      ...
      if(!rtnPg.equals("sucess")){
          ...
          util.updAccessLog(req,res,"Msg form", "delete start");
      MsgDtlForm udf = (MsgDtlForm) af;

      String    idn  = util.nvl(req.getParameter("id"));
      String delQ = " delete df_msg_log where msg_id = ? ";
      ArrayList ary  = new ArrayList();

      ary.add(idn);

      int ct = db.execUpd(" del msg", delQ, ary);
          util.updAccessLog(req,res,"Msg form", "delete end");
      return load(am, af, req, res);
      }
  }
    ...
    public String init(HttpServletRequest req , HttpServletResponse res,HttpSession session,DBUtil util) {
            ...
            System.out.print("New Session Id :="+session.getId());
                ...
                util.updAccessLog(req,res,"Msg form", "Unauthorized Access");
                else
                util.updAccessLog(req,res,"Msg form", "init");
            }
            }
            return rtnPg;
         }
