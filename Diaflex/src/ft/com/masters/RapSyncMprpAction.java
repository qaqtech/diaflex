...
import ft.com.role.RoleForm;
    ...
    public class RapSyncMprpAction extends DispatchAction {
        private final String formName   = "rapSyncMprpForm";


        public RapSyncMprpAction() {
            super();
        }
        ...
        public ActionForward save(ActionMapping am, ActionForm af, HttpServletRequest req, HttpServletResponse res)
            ...
            if (udf.getAddnew() != null) {
                ...
                for (int i = 1; i <= lmt; i++) {
                    ...
                    String insIntoQ = " insert into RAP_SYNC_PRP_MAP (idn ";
            ...
            if (udf.getModify() != null) {
                ...
                String    getMenu = "select " + helper.getSrchFields(daos, "mprp", false) + " from RAP_SYNC_PRP_MAP  ";
                ArrayList    params  = new ArrayList();
                ResultSet rs      = db.execSql("getUIFormFields for update", getMenu, params);

                while (rs.next()) {
                    String    lIdn  = rs.getString(1);
                    String updQ  = " update RAP_SYNC_PRP_MAP set  ";
