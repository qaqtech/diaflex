...
public class MfgFileSeqLogAction extends DispatchAction {
    private final String formName   = "mfgfileseqform";

        public MfgFileSeqLogAction() {
        super();
    }
    ...
    public ActionForward save(ActionMapping am, ActionForm af, HttpServletRequest req, HttpServletResponse res)
        ...
        if(!rtnPg.equals("sucess")){
            ...
            util.updAccessLog(req,res,"mfgfileseqform form", "save start");
        ...
        MfgFileSeqLogForm udf = (MfgFileSeqLogForm) af;
        ...
        if (udf.getAddnew() != null) {
            ...
            for (int i = 1; i <= lmt; i++) {
                ...
                String insIntoQ = " insert into MFG_FILE_SEQ_LOG ( idn ";
                String insValQ  = "values(MFG_FILE_SEQ_LOG_SEQ.nextval ";
        ...
        if (udf.getModify() != null) {
            ...
            String    getMenu = "select " + helper.getSrchFields(daos, "idn", false) + " from MFG_FILE_SEQ_LOG  ";
            ArrayList    params  = new ArrayList();
            ResultSet rs      = db.execSql("getUIFormFields for update", getMenu, params);

            while (rs.next()) {
                String    lIdn  = rs.getString(1);
                String updQ  = " update MFG_FILE_SEQ_LOG set idn = idn ";
        ...
        req.setAttribute("errors", errorList);
            util.updAccessLog(req,res,"mfgfileseqform form", "save end");
    ...
    public ActionForward load(ActionMapping am, ActionForm af, HttpServletRequest req, HttpServletResponse res)
        ...
        if(!rtnPg.equals("sucess")){
            ...
            util.updAccessLog(req,res,"mfgfileseqform form", "load start");
            HashMap  formFields = info.getFormFields(formName);
        ...
        // udf = (MfgFileSeqLogForm)helper.getForm(uiForms, "", srchFields, srchQ, new ArrayList(), daos, "VIEW") ;
        req.setAttribute(formName, list);

        // udf.setList(list);
        // info.setNmeSrchList(list);
        util.updAccessLog(req,res,"mfgfileseqform form", "load end");
  ...
  public ActionForward delete(ActionMapping am, ActionForm af, HttpServletRequest req, HttpServletResponse res)
      ...
      if(!rtnPg.equals("sucess")){
          ...
          util.updAccessLog(req,res,"mfgfileseqform form", "delete start");
      MfgFileSeqLogForm udf = (MfgFileSeqLogForm) af;

      String    idn  = util.nvl(req.getParameter("idn"));
      String delQ = " delete MFG_FILE_SEQ_LOG where idn=? ";
      ArrayList ary  = new ArrayList();

      ary.add(idn);

      int ct = db.execUpd(" del msg", delQ, ary);
          util.updAccessLog(req,res,"mfgfileseqform form", "delete end");
      return load(am, af, req, res);
      }
  }
    ...
    public String init(HttpServletRequest req , HttpServletResponse res,HttpSession session,DBUtil util) {
            ...
            System.out.print("New Session Id :="+session.getId());
                ...
                util.updAccessLog(req,res,"mfgfileseqform form", "Unauthorized Access");
                else
                util.updAccessLog(req,res,"mfgfileseqform form", "init");
            }
            }
            return rtnPg;
         }
