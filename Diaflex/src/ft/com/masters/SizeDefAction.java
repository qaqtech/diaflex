...
public class SizeDefAction extends DispatchAction {

    private final String formName   = "mszform";

        public SizeDefAction() {
        super();
    }
    ...
    public ActionForward save(ActionMapping am, ActionForm af, HttpServletRequest req, HttpServletResponse res)
        ...
        if (udf.getAddnew() != null) {
            ...
            for (int i = 1; i <= lmt; i++) {
                ...
                String insIntoQ = " insert into msz ( idn ";
                String insValQ  = "values(SEQ_MSZ.nextval ";
        ...
        if (udf.getModify() != null) {
            ...
            while (rs.next()) {
                ...
                String updQ  = " update msz set idn = idn ";
  ...
  public ActionForward delete(ActionMapping am, ActionForm af, HttpServletRequest req, HttpServletResponse res)
      ...
      int    idn  = udf.getId();
      String delQ = " delete from msz where idn = ? ";
