...
public class LotPrpAction extends DispatchAction {
    private final String formName   = "LotPrpForm";
    ...
    public ActionForward save(ActionMapping am, ActionForm af, HttpServletRequest req, HttpServletResponse res)
        ...
        if (udf.getAddnew() != null) {
            ...
            for (int i = 1; i <= lmt; i++) {
                ...
                String insIntoQ = " insert into lot_prp (idn,mprp ";
                String insValQ  = "values(lot_prp_seq.nextval,'RO' ";
        ...
        if (udf.getDelete() != null) {
            ...
            if(!lIdnlst.equals("")){
                ...
                int ct = db.execUpd(" del msg", "delete lot_prp where idn in("+lIdnlst+")", new ArrayList());
            }
        }
    ...
    public ActionForward delete(ActionMapping am, ActionForm af, HttpServletRequest req, HttpServletResponse res)
        ...
        String delQ = " delete lot_prp where idn = ? ";
