...
public class SubAtrDtlAction extends DispatchAction {
    private final String formName   = "prpnme";

    public SubAtrDtlAction() {
        super();
    }
    public ActionForward load(ActionMapping am, ActionForm af, HttpServletRequest req, HttpServletResponse res)
        ...
        if(!rtnPg.equals("sucess")){
            ...
            util.updAccessLog(req,res,"Sub Attributes Detail", "load start");
        ...
        SubAtrDtlForm udf = (SubAtrDtlForm) af;
        ...
        String    srchFields = helper.getSrchFields(daos, "mprp_nme");
        ...
        udf.setValue("mprp", mprp);
            util.updAccessLog(req,res,"Sub Attributes Detail", "load end");
    ...
    public ActionForward save(ActionMapping am, ActionForm af, HttpServletRequest req, HttpServletResponse res)
        ...
        if(!rtnPg.equals("sucess")){
            ...
            util.updAccessLog(req,res,"Sub Attributes Detail", "save start");
            HashMap  formFields = info.getFormFields(formName);
        ...
        if (udf.getAddnew() != null) {
            ...
            for (int i = 1; i <= lmt; i++) {
                ...
                ArrayList params   = new ArrayList();
                String insIntoQ = " insert into prp_nme (mprp  ";
        ...
        if (udf.getModify() != null) {
            ...
            while (rs.next()) {
                ...
                String updQ  = " update prp_nme set  ";
        ...
        req.setAttribute("errors", errorList);
            util.updAccessLog(req,res,"Sub Attributes Detail", "save end");
    ...
    public String init(HttpServletRequest req , HttpServletResponse res,HttpSession session,DBUtil util) {
            ...
            System.out.print("New Session Id :="+session.getId());
                ...
                rtnPg=util.checkUserPageRights("masters/atrDtl.do?","");
                if(rtnPg.equals("unauthorized"))
                util.updAccessLog(req,res,"Sub Attributes Detail", "Unauthorized Access");
                else
                util.updAccessLog(req,res,"Sub Attributes Detail", "init");
            }
            }
            return rtnPg;
         }
