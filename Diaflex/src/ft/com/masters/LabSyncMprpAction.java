...
public class LabSyncMprpAction extends DispatchAction {
        private final String formName   = "lapSyncMprpForm";


        public LabSyncMprpAction() {
        super();
        }
        ...
        public ActionForward load(ActionMapping am, ActionForm af, HttpServletRequest req, HttpServletResponse res)
            ...
            if(!rtnPg.equals("sucess")){
                ...
                util.updAccessLog(req,res,"Rap Sync Master form", "load start");
            ...
            LabSyncPrpForm udf = (LabSyncPrpForm) af;
            ResultSet rs=null;
            String maxsrt=null;
            ...
            String MaxSrt="select max(srt) srt from RAP_SYNC_PRP_MAP";
            ...
            util.updAccessLog(req,res,"Rap Sync Master form", "load end");
        ...
        public ActionForward save(ActionMapping am, ActionForm af, HttpServletRequest req, HttpServletResponse res)
            ...
            if(!rtnPg.equals("sucess")){
                ...
                util.updAccessLog(req,res,"Rap Sync Master form", "save start");
                HashMap  formFields = info.getFormFields(formName);
            ...
            if (udf.getAddnew() != null) {
                ...
                for (int i = 1; i <= lmt; i++) {
                    ...
                    String insIntoQ = " insert into GIA_SYNC_PRP_MAP (idn ";
            ...
            if (udf.getModify() != null) {
                ...
                String    getMenu = "select " + helper.getSrchFields(daos, "mprp", false) + " from GIA_SYNC_PRP_MAP  ";
                ArrayList    params  = new ArrayList();
                ResultSet rs      = db.execSql("getUIFormFields for update", getMenu, params);

                while (rs.next()) {
                    String    lIdn  = rs.getString(1);
                    String updQ  = " update GIA_SYNC_PRP_MAP set  ";
                    String condQ = " where mprp = ? ";
                    boolean isValid = false;
...
//            util.initPrp();
                util.updAccessLog(req,res,"Rap Sync Master form", "save end");
        ...
        public String init(HttpServletRequest req , HttpServletResponse res,HttpSession session,DBUtil util) {
                ...
                System.out.print("New Session Id :="+session.getId());
                    ...
                    util.updAccessLog(req,res,"Rap Sync Master form", "Unauthorized Access");
                    else
                    util.updAccessLog(req,res,"Rap Sync Master form", "init");
                }
                }
                return rtnPg;
             }
