...
public class DeptAction  extends  DispatchAction {
    ...
    private final String formName   = "deptform";
    ...
    public ActionForward save(ActionMapping am, ActionForm af, HttpServletRequest req, HttpServletResponse res)
        ...
        if(!rtnPg.equals("sucess")){
            ...
            util.updAccessLog(req,res,"Dept form", "save start");
        ...
        if (udf.getAddnew() != null) {
            ...
            for (int i = 1; i <= lmt; i++) {
                ...
                String insIntoQ = " insert into mdept ( idn ";
                String insValQ  = "values(MDEPT_IDN.nextval ";
        ...
        if (udf.getModify() != null) {
            ...
            String    getMenu = "select " + helper.getSrchFields(daos, "idn", false) + " from mdept ";
            ArrayList    params  = new ArrayList();
            ResultSet rs      = db.execSql("getUIFormFields for update", getMenu, params);

            while (rs.next()) {
                int    lIdn  = rs.getInt(1);
                String updQ  = " update mdept set idn = idn ";
        ...
        req.setAttribute("errors", errorList);
            util.updAccessLog(req,res,"Dept form", "save end");
    ...
    public ActionForward load(ActionMapping am, ActionForm af, HttpServletRequest req, HttpServletResponse res)
        ...
        if(!rtnPg.equals("sucess")){
            ...
            util.updAccessLog(req,res,"Dept form", "load start");
            HashMap  formFields = info.getFormFields(formName);
        ...
        String MaxSrt="select max(srt) srt from mdept";
        ...
        rs.close();
            util.updAccessLog(req,res,"Dept form", "load end");
    ...
    public String init(HttpServletRequest req , HttpServletResponse res,HttpSession session,DBUtil util) {
            ...
            System.out.print("New Session Id :="+session.getId());
                ...
                util.updAccessLog(req,res,"Dept form", "Unauthorized Access");
                else
                util.updAccessLog(req,res,"Dept form", "init");
            }
            }
            return rtnPg;
         }
