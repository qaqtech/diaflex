...
public class ChargesAction extends DispatchAction {
    private final String formName   = "chargesform";
    ...
    public ActionForward save(ActionMapping am, ActionForm af, HttpServletRequest req, HttpServletResponse res)
        ...
        if(!rtnPg.equals("sucess")){
            ...
            util.updAccessLog(req,res,"Charges form", "save start");
        ...
        ChargesForm udf = (ChargesForm) af;
        ...
        if (udf.getAddnew() != null) {
            ...
            for (int i = 1; i <= lmt; i++) {
                ...
                String insIntoQ = " insert into Charges_Typ ( idn ";
                String insValQ  = "values(Charges_Typ_seq.nextval ";
        ...
        if (udf.getModify() != null) {
            ...
            String    getMenu = "select " + helper.getSrchFields(daos, "idn", false) + " from Charges_Typ  ";
            ArrayList    params  = new ArrayList();
            ResultSet rs      = db.execSql("getUIFormFields for update", getMenu, params);

            while (rs.next()) {
                int    lIdn  = rs.getInt(1);
                String updQ  = " update Charges_Typ set idn = idn ";
        ...
        if (udf.getDelete() != null) {
            ...
            if(!lIdnlst.equals("")){
                ...
                int ct = db.execUpd(" del msg", "update Charges_Typ set stt='IA',flg='IA' where idn in("+lIdnlst+")", new ArrayList());
            }
        }
        req.setAttribute("errors", errorList);
            util.updAccessLog(req,res,"Charges form", "save end");
    ...
    public ActionForward load(ActionMapping am, ActionForm af, HttpServletRequest req, HttpServletResponse res)
        ...
        if(!rtnPg.equals("sucess")){
            ...
            util.updAccessLog(req,res,"Charges form", "load start");
            HashMap  formFields = info.getFormFields(formName);
        ...
        // udf = (ChargesForm)helper.getForm(uiForms, "", srchFields, srchQ, new ArrayList(), daos, "VIEW") ;
        req.setAttribute(formName, list);

        // udf.setList(list);
        // info.setNmeSrchList(list);
        util.updAccessLog(req,res,"Charges form", "load end");
  ...
  public ActionForward delete(ActionMapping am, ActionForm af, HttpServletRequest req, HttpServletResponse res)
      ...
      if(!rtnPg.equals("sucess")){
          ...
          util.updAccessLog(req,res,"Charges form", "delete start");
      ChargesForm udf = (ChargesForm) af;

      String    idn  = util.nvl(req.getParameter("id"));
      String delQ = " update Charges_Typ set stt='IA',flg='IA' where idn = ? ";
      ArrayList ary  = new ArrayList();

      ary.add(idn);

      int ct = db.execUpd(" del msg", delQ, ary);
          util.updAccessLog(req,res,"Charges form", "delete end");
      return load(am, af, req, res);
      }
  }
    ...
    public String init(HttpServletRequest req , HttpServletResponse res,HttpSession session,DBUtil util) {
            ...
            System.out.print("New Session Id :="+session.getId());
                ...
                util.updAccessLog(req,res,"Charges form", "Unauthorized Access");
                else
                util.updAccessLog(req,res,"Charges form", "init");
            }
            }
            return rtnPg;
         }
