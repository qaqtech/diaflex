...
public class LabSyncPrpAction extends DispatchAction {
       
        private final String formName   = "lapSyncprpForm";


        public LabSyncPrpAction() {
            super();
        }
        ...
        public ActionForward save(ActionMapping am, ActionForm af, HttpServletRequest req, HttpServletResponse res)
            ...
            if (udf.getAddnew() != null) {
                ...
                for (int i = 1; i <= lmt; i++) {
                    ...
                    ArrayList params   = new ArrayList();
                    String insIntoQ = " insert into GIA_SYNC_PRP_VALS (idn,mprp  ";
            ...
            if (udf.getModify() != null) {
                ...
                String    getMenu = "select " + helper.getSrchFields(daos, "idn", false) + " from GIA_SYNC_PRP_VALS where mprp=? ";
                ArrayList    params  = new ArrayList();
                params.add(udf.getValue("mprp"));
                ...
                while (rs.next()) {
                    ...
                    String updQ  = " update GIA_SYNC_PRP_VALS set  ";
...
//            util.initPrp();
        ...
        public String init(HttpServletRequest req , HttpServletResponse res,HttpSession session,DBUtil util) {
                ...
                System.out.print("New Session Id :="+session.getId());
                    ...
                    rtnPg=util.checkUserPageRights("masters/labsyncmprp.do?","");
