...
public class SaleDeliveryByBillingPrt  extends DispatchAction {

    public SaleDeliveryByBillingPrt() {
        super();
    }
    ...
    public ActionForward load(ActionMapping am, ActionForm af, HttpServletRequest req, HttpServletResponse res)
        ...
        SaleDeliveryByBillingForm udf = (SaleDeliveryByBillingForm) af;
        
        ArrayList byrList = new ArrayList();
        String    getByr  = "select distinct a.nme_idn, a.nme byr \n" + 
        "from nme_v a ,nme_grp b,nme_grp_dtl c, sal_pndg_v d\n" + 
        "where a.nme_idn = c.nme_idn and b.nme_grp_idn = c.nme_grp_idn\n" + 
        "and b.nme_idn=d.nme_idn and d.typ='SL' and d.pkt_ty in('NR')\n" + 
    ...
    public ActionForward loadPkt(ActionMapping am, ActionForm af, HttpServletRequest req, HttpServletResponse res)
        ...
        if(nmeId.equals("")){
                    ...
                    int cnt=0;
                        ...
                        "and d.stt='IS' and e.stt='SL' and d.typ in ('SL') and d.flg1='CNF' \n" + 
                      ...
                      ResultSet  rs1= (ResultSet)outLst.get(1);
                       ...
                       pst1 = (PreparedStatement)outLst.get(0);
...
//           }
       ...
       while(rs1.next()){
           ...
           ByrNme = util.nvl(rs1.getString("byr"));
       }
            rs1.close();
            pst1.close();
        String getPktData =
        ...
        " c.idn = a.idn and a.stt='SL' and c.typ in ('SL') and c.flg1='CNF'  and c.nmerel_idn = d.nmerel_idn and d.nme_idn=e.nme_idn and  c.stt='IS'  ";
...
//        }
    ...
    public String init(HttpServletRequest req , HttpServletResponse res,HttpSession session,DBUtil util) {
            ...
            System.out.print("New Session Id :="+session.getId());
                ...
                util.updAccessLog(req,res,"Sale Delivery Billing", "Unauthorized Access");
                else
                util.updAccessLog(req,res,"Sale Delivery Billing", "init");
            }
            }
            return rtnPg;
            }
