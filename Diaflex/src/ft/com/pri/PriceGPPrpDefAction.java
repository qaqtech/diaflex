...
public class PriceGPPrpDefAction extends DispatchAction {
    ...
    public ActionForward load(ActionMapping am, ActionForm af, HttpServletRequest req, HttpServletResponse res)
      ...
      if(!rtnPg.equals("sucess")){
          ...
          util.updAccessLog(req,res,"PriceGPPrpDefAction", "load");
          HashMap  formFields = info.getFormFields("pricegpprpdefform");

          if ((formFields == null) || (formFields.size() == 0)) {
              formFields = util.getFormFields("pricegpprpdefform");
          }
        ...
        PriceGPPrpDefForm udf = (PriceGPPrpDefForm) af;
        String idn=null;
        ...
        String nmeidn = req.getParameter("idn");
        ...
        req.setAttribute("pricegpprpdefform", list);
        util.SOP(" NmeSearch Count : " + list.size());
          util.updAccessLog(req,res,"PriceGPPrpDefAction", "load end");
    ...
    public ActionForward save(ActionMapping am, ActionForm af, HttpServletRequest req, HttpServletResponse res)
      ...
      if(!rtnPg.equals("sucess")){
          ...
          util.updAccessLog(req,res,"PriceGPPrpDefAction", "save");
          HashMap  formFields = info.getFormFields("pricegpprpdefform");
          ...
          ResultSet rs = (ResultSet)rsLst.get(1);
            ...
            while (rs.next()) {
                String    lIdn  = rs.getString(1);
                 String   from  = rs.getString("vfr");
                String   to  = rs.getString("vto");
                String   srt  = rs.getString("srt");
                String   flg  = rs.getString("flg");
                String updQ  = " update pri_grp_prp_dtl set  ";
                String condQ = " where pri_grp_prp_idn = ? and vfr = ? and  vto = ? and srt = ? and flg = ?" ;
                boolean isValid = false;
        ...
        if (udf.getDelete() != null) {
            ...
            while (rs.next()) {
                ...
                params = new ArrayList();
                if (isChecked.length() > 0) {
                    String delQ = "delete pri_grp_prp_dtl where pri_grp_prp_idn = ? and vfr = ? and  vto = ?" ;
                    params.add(lIdn);
                    params.add(from);
                    params.add(to);
//                    params.add(srt);
//                    params.add(flg);                                      
                    int ct = db.execDirUpd(" delete menu " + lIdn, delQ, params);
                }
            }
            rs.close();
        }
...
//        util.initPrp();
          util.updAccessLog(req,res,"PriceGPPrpDefAction", "save end");
