...
import ft.com.masters.ProcessMasterAction;
...
public class MixClrMapping extends DispatchAction {
   
    public MixClrMapping() {
        super();
    }
      ...
      if(!rtnPg.equals("sucess")){
        ...
        if (udf.getAddnew() != null) {
            ...
            for (int i = 1; i <= lmt; i++) {
                ...
                String insIntoQ = " insert into mix_clarity_mapping ( idn ";
                String insValQ  = "values(mix_clarity_mapping_SEQ.nextval ";
        ...
        if (udf.getModify() != null) {
            ...
            String    getMenu = "select " + helper.getSrchFields(daos, "idn", false) + " from mix_clarity_mapping  ";
            ArrayList    params  = new ArrayList();
            ResultSet rs      = db.execSql("getUIFormFields for update", getMenu, params);

            while (rs.next()) {
                int    lIdn  = rs.getInt(1);
                String updQ  = " update mix_clarity_mapping set idn = idn ";
    ...
    public ActionForward load(ActionMapping am, ActionForm af, HttpServletRequest req, HttpServletResponse res)
      ...
      if(!rtnPg.equals("sucess")){
        ...
        req.setAttribute("mixclarityFrm", list);
