...
public class MixFinalRtnImpl  implements MixFinalRtnInterface {
   
    public MixFinalRtnImpl() {
        super();
    }
...
//        init(req,res);
//        ArrayList asViewPrp = (ArrayList)session.getAttribute("MIXFNRtNMatrixGNCSrch");
//        try {
//            if (asViewPrp == null) {
//
//                asViewPrp = new ArrayList();
//                ResultSet rs1 =
//                    db.execSql(" Vw Lst ", "Select prp,flg  from rep_prp where mdl = 'MIX_FNLRTN_SRCH' and flg in ('Y','S','M') order by rnk ",
//                               new ArrayList());
//                while (rs1.next()) {
...
//                }
//                rs1.close();
//                session.setAttribute("MIXFNRtNMatrixGNCSrch", asViewPrp);
//            }
//
//        } catch (SQLException sqle) {
//            // TODO: Add catch code
    ...
    public HashMap FecthResult(HttpServletRequest req, HttpServletResponse res, HashMap params){
      ...
      util.setLogApplNm(info.getLoApplNm());
        ...
        try {
                ...
                String distinctPRP ="select distinct "+prpSH+" from gt_srch_rslt";
        ...
        String rsltQ = srchQ + " from gt_srch_rslt ";
          ArrayList  rsLst = db.execSqlLst("gt fetch", rsltQ, new ArrayList());
          PreparedStatement  stmt =(PreparedStatement)rsLst.get(0);
          ResultSet  rs =(ResultSet)rsLst.get(1);
