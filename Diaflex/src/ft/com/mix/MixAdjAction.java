...
public class MixAdjAction extends DispatchAction {
    ...
    public ActionForward save(ActionMapping am, ActionForm af, HttpServletRequest req, HttpServletResponse res)
      ...
      if(!rtnPg.equals("sucess")){
          ...
          util.updAccessLog(req,res,"MixAdjAction", "load");
          HashMap  formFields = info.getFormFields("mixadjform");

          if ((formFields == null) || (formFields.size() == 0)) {
              formFields = util.getFormFields("mixadjform");
          }
        ...
        if (udf.getAddnew() != null) {
            ...
            for (int i = 1; i <= lmt; i++) {
                ...
                String insIntoQ = " insert into MIX_ADJ ( idn ";
                String insValQ  = "values(MIX_ADJ_SEQ.nextval ";
        ...
        if (udf.getModify() != null) {
            ...
            String    getMenu = "select " + helper.getSrchFields(daos, "idn", false) + " from MIX_ADJ  ";
            ArrayList    params  = new ArrayList();
            ResultSet rs      = db.execSql("getUIFormFields for update", getMenu, params);

            while (rs.next()) {
                int    lIdn  = rs.getInt(1);
                String updQ  = " update MIX_ADJ set idn = idn ";
        ...
        if (udf.getDelete() != null) {
            ...
            if(!lIdnlst.equals("")){
                ...
                int ct = db.execUpd(" del msg", "update MIX_ADJ set stt='IA' where idn in("+lIdnlst+")", new ArrayList());
            }
        }
        req.setAttribute("errors", errorList);
          util.updAccessLog(req,res,"MixAdjAction", "load end");
    ...
    public ActionForward load(ActionMapping am, ActionForm af, HttpServletRequest req, HttpServletResponse res)
      ...
      if(!rtnPg.equals("sucess")){
        ...
        // udf = (MixAdjForm)helper.getForm(uiForms, "", srchFields, srchQ, new ArrayList(), daos, "VIEW") ;
        req.setAttribute("mixadjform", list);
  ...
  public ActionForward delete(ActionMapping am, ActionForm af, HttpServletRequest req, HttpServletResponse res)
    ...
    if(!rtnPg.equals("sucess")){
        ...
        util.updAccessLog(req,res,"MixAdjAction", "delete");

      String    idn  = util.nvl(req.getParameter("id"));
      String delQ = " update MIX_ADJ set stt='IA' where idn = ? ";
      ArrayList ary  = new ArrayList();

      ary.add(idn);

      int ct = db.execUpd(" del msg", delQ, ary);
        util.updAccessLog(req,res,"MixAdjAction", "end");
      return load(am, af, req, res);
      }
  }
  ...
  public String init(HttpServletRequest req , HttpServletResponse res,HttpSession session,DBUtil util) {
          ...
          System.out.print("New Session Id :="+session.getId());
              ...
              util.updAccessLog(req,res,"Mix Adj Action", "Unauthorized Access");
              else
          util.updAccessLog(req,res,"Mix Adj Action", "init");
          }
          }
          return rtnPg;
       }
